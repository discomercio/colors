namespace Reciprocidade
{
    partial class FArqRetorno
    {
        ...
        private void InitializeComponent()
        {
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FArqRetorno));
			...
			this.label1.Text = "Carga do Arquivo de Retorno";
			...
			this.btnSelecionaArqRetorno.TabIndex = 6;
			...
			this.grdBoletos.DefaultCellStyle = dataGridViewCellStyle8;
			...
			this.data_emissao.MinimumWidth = 110;
			...
			this.data_vencimento.MinimumWidth = 110;
			...
			this.data_pagamento.MinimumWidth = 110;
			...
			// ocorrencia
			// 
			this.ocorrencia.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode.Fill;
			...
			this.ocorrencia.MinimumWidth = 250;
			...
			this.btnCarregaArqRetorno.TabIndex = 8;
			...
			this.Name = "FArqRetorno";
			this.Text = "FArqRetorno";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FArqRetorno_FormClosing);
			this.Load += new System.EventHandler(this.FArqRetorno_Load);
			this.Shown += new System.EventHandler(this.FArqRetorno_Shown);

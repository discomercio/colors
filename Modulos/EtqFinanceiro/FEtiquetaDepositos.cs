...
{
    public partial class FEtiquetaDepositos : FModelo
    {
        #region [ Constantes ]
        ...
        private List<EtiquetaDepositosDados> _listaEtqCompleta = new List<EtiquetaDepositosDados>();
        ...
        private bool executaConsulta()
        {
            ...
            DataRow rowConsulta;
            EtiquetaDepositosDados etiqueta;
            ...
            try
            {
                ...
                try
                {
                    ...
                    for (int i = 0; i < _dtbConsulta.Rows.Count; i++)
                    {
                        ...
                        etiqueta = new EtiquetaDepositosDados();
        ...
        private bool montaDadosImpressaoEtiqueta(EtiquetaDepositosDados etiqueta, out string textoImpressaoEtiqueta, out string strMsgErro)
        {
            #region [ Declarações ]
        ...
        private bool preencheLinhaGrid(int rowIndex, EtiquetaDepositosDados etiqueta)
        {
            try
            {
        ...
        private void trataBotaoImprimirSelecionado()
        {
            ...
            StringBuilder sbEtiqueta = new StringBuilder();
            Log log = new Log();
            EtiquetaDepositosDados etiqueta = new EtiquetaDepositosDados();
            #endregion
        ...
        #region [ FEtiquetaDepositosDados ]

        #region [ EFtiquetaDepositosDados ]
        private void EFtiquetaDepositosDados_Load(object sender, EventArgs e)
        {
        ...
        #region [ FEtiquetaDepositosDados_Shown ]
        private void FEtiquetaDepositosDados_Shown(object sender, EventArgs e)
        {
            try
            {
    ...
    #region [ EtiquetaDepositosDados ]
    public class EtiquetaDepositosDados
    {

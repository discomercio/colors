...
namespace WebHook.Models.Domains
{
	public static class Global
	{
		...
		public class Cte
		{
			...
			public class Aplicativo
			{
				...
				public const string NOME_SISTEMA = "Webhook";
			...
			/*================================================================================================
			 * v 1.00 - 23.08.2016 - por HHO
			 *		Início: desenvolvimento de WebAPI para receber os dados do webhook da Braspag referentes
			 *		ao pagamento dos boletos de e-commerce.
			 * -----------------------------------------------------------------------------------------------
			 * v 1.01 - 10.11.2016 - por TRR
			 *		Desenvolvimento de controller para validar o dígito verificador da inscrição estadual
			 *		e que será usado pelo site Magento da Bonshop.
			 * -----------------------------------------------------------------------------------------------
			 * v 1.02 - 04.08.2018 - por HHO
			 *		Retirada da validação do dígito verificador da inscrição estadual, pois essa funcionali-
			 *		dade foi transferida para uma nova WebAPI que será destinada exclusivamente para oferecer
			 *		serviços a terceiros e que será configurada com restrição de acesso baseada no IP de
			 *		origem.

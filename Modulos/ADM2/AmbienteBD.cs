...
namespace ADM2
{
	...
	public class AmbienteBD
	{
		...
		public readonly string NumeroLoja;
		#endregion
		...
		public IbptDadosDAO ibptDadosDAO;
		...
		#region [ Constructor ]
		public AmbienteBD(string nomeAmbiente, string enderecoServidor, string nomeBancoDados, string nomeUsuarioBD, string senhaUsuarioCriptografada, string numeroLoja)
		{
			#region [ Declarações ]
		...
		public bool inicializaObjetosDAO(out string msgErroCompleto, out string msgErroResumido)
		{
			...
			try
			{
				...
				ibptDadosDAO = new IbptDadosDAO(ref BD);
				parametroDAO = new ParametroDAO(ref BD);

            ...
            try
            {
                ...
                for (int iv = 0; iv < _vRastreio.Count; iv++)
                {
                    ...
                    else
                    {
                        ...
                        sOrdenacao = Global.normalizaCodigo("3", 2) + Global.normalizaCodigo(_vRastreio[iv].dadosNormalizado.numSerieNF.ToString(), 3) + Global.normalizaCodigo(_vRastreio[iv].dadosNormalizado.numNF.ToString(), 9);
                        #endregion
                    }
                    ...
                    try
                    {
                        ...
                        for (int iv = 0; iv < vRastreioOrdenado.Count; iv++)
                        {
                            ...
                            else
                            {
                                ...
                                grid.Rows[iv].DefaultCellStyle.BackColor = Color.Pink;
                            }
                        }
                    }
                    finally

...
namespace ADM2
{
    ...
    {
        STATUS_INICIAL = 0,
        ERRO_INCONSISTENCIA = 1,
        LIBERADO_PARA_REGISTRAR_PEDIDO_RECEBIDO_CLIENTE = 2,
        SUCESSO_REGISTRO_PEDIDO_RECEBIDO_CLIENTE = 3,
        FALHA_REGISTRO_PEDIDO_RECEBIDO_CLIENTE = 4
    }
    ...
    public enum eRastreioPedidoRecebidoClienteProcessoCodigoErro
    {
        ...
        SEM_ERRO = 0,
        NUMERO_NF_NAO_INFORMADO = 1,
        NUMERO_NF_NAO_ENCONTRADO = 2,
        NUMERO_NF_FORMATO_INVALIDO = 3,
        PEDIDO_NAO_LOCALIZADO_POR_NF = 4,
        MULTIPLOS_PEDIDOS_LOCALIZADOS_PARA_NF = 5,
        PEDIDO_RECEBIDO_JA_REGISTRADO = 6,
        PEDIDO_ST_ENTREGA_INVALIDO = 7,
        PEDIDO_SEM_TRANSPORTADORA_CADASTRADA = 8,
        DATA_RECEBIMENTO_ANTERIOR_DATA_PEDIDO_ENTREGUE = 9,
        CNPJ_CPF_DIVERGENTE = 10,
        OCORRENCIA_REPETIDA = 11,
        OCORRENCIA_SEM_DATA_RECEBIMENTO = 99
    }
    ...
    class RastreioPedidoRecebidoClienteProcesso
    {
        ...
        public eRastreioPedidoRecebidoClienteProcessoStatus Status { get; set; } = eRastreioPedidoRecebidoClienteProcessoStatus.STATUS_INICIAL;

...
{
	partial class FFluxoDebitoLote
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.colPlanoContasEmpresa = new System.Windows.Forms.DataGridViewComboBoxColumn();
			...
			// pnBotoes
			// 
			this.pnBotoes.Size = new System.Drawing.Size(1098, 55);
			// 
			// pnCampos
			// 
			...
			this.pnCampos.Size = new System.Drawing.Size(1098, 609);
			// 
			// btnDummy
			// 
			...
			// btnFechar
			// 
			this.btnFechar.Location = new System.Drawing.Point(1049, 4);
			this.btnFechar.TabIndex = 1;
			// 
			// btnSobre
			// 
			this.btnSobre.Location = new System.Drawing.Point(1004, 4);
			...
			this.lblTitulo.Size = new System.Drawing.Size(1094, 40);
			this.lblTitulo.TabIndex = 0;
			this.lblTitulo.Text = "Lançamentos de Débito em Lote";
			...
			// gboxDefault
			// 
			this.gboxDefault.Controls.Add(this.txtComp2);
			this.gboxDefault.Controls.Add(this.lblComp2);
			...
			this.gboxLote.Size = new System.Drawing.Size(1075, 332);
			...
			this.grdLote.Size = new System.Drawing.Size(1069, 313);
			...
			this.colPlanoContasEmpresa.Name = "colPlanoContasEmpresa";
			this.colPlanoContasEmpresa.Width = 120;
			// 
			// colPlanoContasConta
			// 
			...
			this.colPlanoContasConta.Width = 210;
			// 
			// colDataCompetencia
			// 
			...
			this.lblTitQtdeLancamentos.TabIndex = 17;
			...
			this.lblQtdeLancamentos.TabIndex = 18;
			...
			this.lblTitValorTotal.TabIndex = 19;
			...
			this.Name = "FFluxoDebitoLote";
			this.Text = "Artven - Financeiro  -  1.00 - xx.JUL.2009";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.FFluxoDebitoLote_FormClosing);
			this.Load += new System.EventHandler(this.FFluxoDebitoLote_Load);
			this.Shown += new System.EventHandler(this.FFluxoDebitoLote_Shown);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.FFluxoDebitoLote_KeyDown);
			this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.FFluxoDebitoLote_KeyPress);
		...
		private System.Windows.Forms.DataGridViewComboBoxColumn colPlanoContasEmpresa;

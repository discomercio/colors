...
{
	partial class FFluxoRelatorioMovimentoSinteticoComparativo
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FFluxoRelatorioMovimentoSinteticoComparativo));
			this.lblTitulo = new System.Windows.Forms.Label();
			this.pnParametros = new System.Windows.Forms.Panel();
			this.gbCompetencia = new System.Windows.Forms.GroupBox();
			this.rbCompetenciaComparativoEntrePeriodos = new System.Windows.Forms.RadioButton();
			this.rbCompetenciaComparativoMensal = new System.Windows.Forms.RadioButton();
			this.gbCompetenciaComparativoMensal = new System.Windows.Forms.GroupBox();
			this.gbCompetenciaComparativoMensalFim = new System.Windows.Forms.GroupBox();
			this.cbCompetenciaAnoFinal = new System.Windows.Forms.ComboBox();
			this.cbCompetenciaMesFinal = new System.Windows.Forms.ComboBox();
			this.gbCompetenciaComparativoMensalInicio = new System.Windows.Forms.GroupBox();
			this.cbCompetenciaAnoInicial = new System.Windows.Forms.ComboBox();
			this.cbCompetenciaMesInicial = new System.Windows.Forms.ComboBox();
			this.gbCompetenciaComparativoEntrePeriodos = new System.Windows.Forms.GroupBox();
			this.gbCompetenciaPeriodo2 = new System.Windows.Forms.GroupBox();
			this.txtPeriodo2DataCompetenciaFinal = new System.Windows.Forms.TextBox();
			this.txtPeriodo2DataCompetenciaInicial = new System.Windows.Forms.TextBox();
			this.label1 = new System.Windows.Forms.Label();
			this.gbCompetenciaPeriodo1 = new System.Windows.Forms.GroupBox();
			this.txtPeriodo1DataCompetenciaFinal = new System.Windows.Forms.TextBox();
			this.txtPeriodo1DataCompetenciaInicial = new System.Windows.Forms.TextBox();
			...
			this.gbCompetenciaComparativoMensal.SuspendLayout();
			this.gbCompetenciaComparativoMensalFim.SuspendLayout();
			this.gbCompetenciaComparativoMensalInicio.SuspendLayout();
			this.gbCompetenciaComparativoEntrePeriodos.SuspendLayout();
			this.gbCompetenciaPeriodo2.SuspendLayout();
			this.gbCompetenciaPeriodo1.SuspendLayout();
			this.SuspendLayout();
			// 
			// pnBotoes
			// 
			...
			this.pnBotoes.Controls.SetChildIndex(this.btnConsultar, 0);
			// 
			// pnCampos
			// 
			this.pnCampos.Controls.Add(this.pnParametros);
			this.pnCampos.Controls.Add(this.lblTitulo);
			this.pnCampos.Size = new System.Drawing.Size(1018, 499);
			// 
			// btnDummy
			// 
			...
			this.lblTitulo.Text = "Relatório Sintético Comparativo de Movimentos";
			this.lblTitulo.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// pnParametros
			// 
			this.pnParametros.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
			this.pnParametros.Controls.Add(this.gbCompetencia);
			...
			this.pnParametros.Size = new System.Drawing.Size(1014, 455);
			this.pnParametros.TabIndex = 2;
			// 
			// gbCompetencia
			// 
			this.gbCompetencia.Controls.Add(this.rbCompetenciaComparativoEntrePeriodos);
			this.gbCompetencia.Controls.Add(this.rbCompetenciaComparativoMensal);
			this.gbCompetencia.Controls.Add(this.gbCompetenciaComparativoMensal);
			this.gbCompetencia.Controls.Add(this.gbCompetenciaComparativoEntrePeriodos);
			this.gbCompetencia.Location = new System.Drawing.Point(104, 11);
			this.gbCompetencia.Name = "gbCompetencia";
			this.gbCompetencia.Size = new System.Drawing.Size(542, 177);
			this.gbCompetencia.TabIndex = 0;
			this.gbCompetencia.TabStop = false;
			// 
			// rbCompetenciaComparativoEntrePeriodos
			// 
			this.rbCompetenciaComparativoEntrePeriodos.AutoSize = true;
			this.rbCompetenciaComparativoEntrePeriodos.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.rbCompetenciaComparativoEntrePeriodos.Location = new System.Drawing.Point(22, 13);
			this.rbCompetenciaComparativoEntrePeriodos.Name = "rbCompetenciaComparativoEntrePeriodos";
			this.rbCompetenciaComparativoEntrePeriodos.Size = new System.Drawing.Size(182, 17);
			this.rbCompetenciaComparativoEntrePeriodos.TabIndex = 0;
			this.rbCompetenciaComparativoEntrePeriodos.TabStop = true;
			this.rbCompetenciaComparativoEntrePeriodos.Text = "Comparativo entre períodos";
			this.rbCompetenciaComparativoEntrePeriodos.UseVisualStyleBackColor = true;
			// 
			// rbCompetenciaComparativoMensal
			// 
			this.rbCompetenciaComparativoMensal.AutoSize = true;
			this.rbCompetenciaComparativoMensal.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.rbCompetenciaComparativoMensal.Location = new System.Drawing.Point(22, 96);
			this.rbCompetenciaComparativoMensal.Name = "rbCompetenciaComparativoMensal";
			this.rbCompetenciaComparativoMensal.Size = new System.Drawing.Size(158, 17);
			this.rbCompetenciaComparativoMensal.TabIndex = 1;
			this.rbCompetenciaComparativoMensal.TabStop = true;
			this.rbCompetenciaComparativoMensal.Text = "Comparativo mês a mês";
			this.rbCompetenciaComparativoMensal.UseVisualStyleBackColor = true;
			// 
			// gbCompetenciaComparativoMensal
			// 
			this.gbCompetenciaComparativoMensal.Controls.Add(this.gbCompetenciaComparativoMensalFim);
			this.gbCompetenciaComparativoMensal.Controls.Add(this.gbCompetenciaComparativoMensalInicio);
			this.gbCompetenciaComparativoMensal.Location = new System.Drawing.Point(12, 98);
			this.gbCompetenciaComparativoMensal.Name = "gbCompetenciaComparativoMensal";
			this.gbCompetenciaComparativoMensal.Size = new System.Drawing.Size(518, 70);
			this.gbCompetenciaComparativoMensal.TabIndex = 3;
			this.gbCompetenciaComparativoMensal.TabStop = false;
			// 
			// gbCompetenciaComparativoMensalFim
			// 
			this.gbCompetenciaComparativoMensalFim.Controls.Add(this.cbCompetenciaAnoFinal);
			this.gbCompetenciaComparativoMensalFim.Controls.Add(this.cbCompetenciaMesFinal);
			this.gbCompetenciaComparativoMensalFim.Location = new System.Drawing.Point(273, 17);
			this.gbCompetenciaComparativoMensalFim.Name = "gbCompetenciaComparativoMensalFim";
			this.gbCompetenciaComparativoMensalFim.Size = new System.Drawing.Size(227, 46);
			this.gbCompetenciaComparativoMensalFim.TabIndex = 1;
			this.gbCompetenciaComparativoMensalFim.TabStop = false;
			this.gbCompetenciaComparativoMensalFim.Text = "Fim";
			// 
			// cbCompetenciaAnoFinal
			// 
			this.cbCompetenciaAnoFinal.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbCompetenciaAnoFinal.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.cbCompetenciaAnoFinal.FormattingEnabled = true;
			this.cbCompetenciaAnoFinal.Items.AddRange(new object[] {
            "2017",
            "2016",
            "2015",
            "2014"});
			this.cbCompetenciaAnoFinal.Location = new System.Drawing.Point(144, 17);
			this.cbCompetenciaAnoFinal.Name = "cbCompetenciaAnoFinal";
			this.cbCompetenciaAnoFinal.Size = new System.Drawing.Size(74, 21);
			this.cbCompetenciaAnoFinal.TabIndex = 1;
			this.cbCompetenciaAnoFinal.SelectedIndexChanged += new System.EventHandler(this.cbCompetenciaAnoFinal_SelectedIndexChanged);
			this.cbCompetenciaAnoFinal.MouseClick += new System.Windows.Forms.MouseEventHandler(this.cbCompetenciaAnoFinal_MouseClick);
			// 
			// cbCompetenciaMesFinal
			// 
			this.cbCompetenciaMesFinal.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbCompetenciaMesFinal.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.cbCompetenciaMesFinal.FormattingEnabled = true;
			this.cbCompetenciaMesFinal.Items.AddRange(new object[] {
            "Janeiro",
            "Fevereiro",
            "Março",
            "Abril",
            ...
            "Novembro",
            "Dezembro"});
			this.cbCompetenciaMesFinal.Location = new System.Drawing.Point(10, 17);
			this.cbCompetenciaMesFinal.Name = "cbCompetenciaMesFinal";
			this.cbCompetenciaMesFinal.Size = new System.Drawing.Size(124, 21);
			this.cbCompetenciaMesFinal.TabIndex = 0;
			this.cbCompetenciaMesFinal.SelectedIndexChanged += new System.EventHandler(this.cbCompetenciaMesFinal_SelectedIndexChanged);
			this.cbCompetenciaMesFinal.MouseClick += new System.Windows.Forms.MouseEventHandler(this.cbCompetenciaMesFinal_MouseClick);
			// 
			// gbCompetenciaComparativoMensalInicio
			// 
			this.gbCompetenciaComparativoMensalInicio.Controls.Add(this.cbCompetenciaAnoInicial);
			this.gbCompetenciaComparativoMensalInicio.Controls.Add(this.cbCompetenciaMesInicial);
			this.gbCompetenciaComparativoMensalInicio.Location = new System.Drawing.Point(18, 17);
			this.gbCompetenciaComparativoMensalInicio.Name = "gbCompetenciaComparativoMensalInicio";
			this.gbCompetenciaComparativoMensalInicio.Size = new System.Drawing.Size(227, 46);
			this.gbCompetenciaComparativoMensalInicio.TabIndex = 0;
			this.gbCompetenciaComparativoMensalInicio.TabStop = false;
			this.gbCompetenciaComparativoMensalInicio.Text = "Início";
			// 
			// cbCompetenciaAnoInicial
			// 
			this.cbCompetenciaAnoInicial.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbCompetenciaAnoInicial.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.cbCompetenciaAnoInicial.FormattingEnabled = true;
			this.cbCompetenciaAnoInicial.Items.AddRange(new object[] {
            "2017",
            "2016",
            "2015",
            "2014"});
			this.cbCompetenciaAnoInicial.Location = new System.Drawing.Point(144, 17);
			this.cbCompetenciaAnoInicial.Name = "cbCompetenciaAnoInicial";
			this.cbCompetenciaAnoInicial.Size = new System.Drawing.Size(74, 21);
			this.cbCompetenciaAnoInicial.TabIndex = 1;
			this.cbCompetenciaAnoInicial.SelectedIndexChanged += new System.EventHandler(this.cbCompetenciaAnoInicial_SelectedIndexChanged);
			this.cbCompetenciaAnoInicial.MouseClick += new System.Windows.Forms.MouseEventHandler(this.cbCompetenciaAnoInicial_MouseClick);
			// 
			// cbCompetenciaMesInicial
			// 
			this.cbCompetenciaMesInicial.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cbCompetenciaMesInicial.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.cbCompetenciaMesInicial.FormattingEnabled = true;
			this.cbCompetenciaMesInicial.Items.AddRange(new object[] {
            "Janeiro",
            "Fevereiro",
            "Março",
            "Abril",
            ...
            "Novembro",
            "Dezembro"});
			this.cbCompetenciaMesInicial.Location = new System.Drawing.Point(10, 17);
			this.cbCompetenciaMesInicial.Name = "cbCompetenciaMesInicial";
			this.cbCompetenciaMesInicial.Size = new System.Drawing.Size(124, 21);
			this.cbCompetenciaMesInicial.TabIndex = 0;
			this.cbCompetenciaMesInicial.SelectedIndexChanged += new System.EventHandler(this.cbCompetenciaMesInicial_SelectedIndexChanged);
			this.cbCompetenciaMesInicial.MouseClick += new System.Windows.Forms.MouseEventHandler(this.cbCompetenciaMesInicial_MouseClick);
			// 
			// gbCompetenciaComparativoEntrePeriodos
			// 
			this.gbCompetenciaComparativoEntrePeriodos.Controls.Add(this.gbCompetenciaPeriodo2);
			this.gbCompetenciaComparativoEntrePeriodos.Controls.Add(this.gbCompetenciaPeriodo1);
			this.gbCompetenciaComparativoEntrePeriodos.Location = new System.Drawing.Point(12, 15);
			this.gbCompetenciaComparativoEntrePeriodos.Name = "gbCompetenciaComparativoEntrePeriodos";
			this.gbCompetenciaComparativoEntrePeriodos.Size = new System.Drawing.Size(518, 70);
			this.gbCompetenciaComparativoEntrePeriodos.TabIndex = 2;
			this.gbCompetenciaComparativoEntrePeriodos.TabStop = false;
			// 
			// gbCompetenciaPeriodo2
			// 
			this.gbCompetenciaPeriodo2.Controls.Add(this.txtPeriodo2DataCompetenciaFinal);
			this.gbCompetenciaPeriodo2.Controls.Add(this.txtPeriodo2DataCompetenciaInicial);
			this.gbCompetenciaPeriodo2.Controls.Add(this.label1);
			this.gbCompetenciaPeriodo2.Location = new System.Drawing.Point(273, 17);
			this.gbCompetenciaPeriodo2.Name = "gbCompetenciaPeriodo2";
			this.gbCompetenciaPeriodo2.Size = new System.Drawing.Size(227, 46);
			this.gbCompetenciaPeriodo2.TabIndex = 55;
			this.gbCompetenciaPeriodo2.TabStop = false;
			this.gbCompetenciaPeriodo2.Text = "Período 2";
			// 
			// txtPeriodo2DataCompetenciaFinal
			// 
			this.txtPeriodo2DataCompetenciaFinal.Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtPeriodo2DataCompetenciaFinal.Location = new System.Drawing.Point(127, 17);
			this.txtPeriodo2DataCompetenciaFinal.MaxLength = 10;
			this.txtPeriodo2DataCompetenciaFinal.Name = "txtPeriodo2DataCompetenciaFinal";
			this.txtPeriodo2DataCompetenciaFinal.Size = new System.Drawing.Size(91, 23);
			this.txtPeriodo2DataCompetenciaFinal.TabIndex = 1;
			this.txtPeriodo2DataCompetenciaFinal.Text = "01/01/2000";
			this.txtPeriodo2DataCompetenciaFinal.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.txtPeriodo2DataCompetenciaFinal.Enter += new System.EventHandler(this.txtPeriodo2DataCompetenciaFinal_Enter);
			this.txtPeriodo2DataCompetenciaFinal.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPeriodo2DataCompetenciaFinal_KeyDown);
			this.txtPeriodo2DataCompetenciaFinal.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtPeriodo2DataCompetenciaFinal_KeyPress);
			this.txtPeriodo2DataCompetenciaFinal.Leave += new System.EventHandler(this.txtPeriodo2DataCompetenciaFinal_Leave);
			// 
			// txtPeriodo2DataCompetenciaInicial
			// 
			this.txtPeriodo2DataCompetenciaInicial.Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtPeriodo2DataCompetenciaInicial.Location = new System.Drawing.Point(10, 17);
			this.txtPeriodo2DataCompetenciaInicial.MaxLength = 10;
			this.txtPeriodo2DataCompetenciaInicial.Name = "txtPeriodo2DataCompetenciaInicial";
			this.txtPeriodo2DataCompetenciaInicial.Size = new System.Drawing.Size(91, 23);
			this.txtPeriodo2DataCompetenciaInicial.TabIndex = 0;
			this.txtPeriodo2DataCompetenciaInicial.Text = "01/01/2000";
			this.txtPeriodo2DataCompetenciaInicial.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.txtPeriodo2DataCompetenciaInicial.Enter += new System.EventHandler(this.txtPeriodo2DataCompetenciaInicial_Enter);
			this.txtPeriodo2DataCompetenciaInicial.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPeriodo2DataCompetenciaInicial_KeyDown);
			this.txtPeriodo2DataCompetenciaInicial.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtPeriodo2DataCompetenciaInicial_KeyPress);
			this.txtPeriodo2DataCompetenciaInicial.Leave += new System.EventHandler(this.txtPeriodo2DataCompetenciaInicial_Leave);
			// 
			// label1
			// 
			...
			this.label1.Text = "a";
			// 
			// gbCompetenciaPeriodo1
			// 
			this.gbCompetenciaPeriodo1.Controls.Add(this.txtPeriodo1DataCompetenciaFinal);
			this.gbCompetenciaPeriodo1.Controls.Add(this.txtPeriodo1DataCompetenciaInicial);
			this.gbCompetenciaPeriodo1.Controls.Add(this.lblDataCompetenciaAte);
			this.gbCompetenciaPeriodo1.Location = new System.Drawing.Point(18, 17);
			this.gbCompetenciaPeriodo1.Name = "gbCompetenciaPeriodo1";
			this.gbCompetenciaPeriodo1.Size = new System.Drawing.Size(227, 46);
			this.gbCompetenciaPeriodo1.TabIndex = 54;
			this.gbCompetenciaPeriodo1.TabStop = false;
			this.gbCompetenciaPeriodo1.Text = "Período 1";
			// 
			// txtPeriodo1DataCompetenciaFinal
			// 
			this.txtPeriodo1DataCompetenciaFinal.Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtPeriodo1DataCompetenciaFinal.Location = new System.Drawing.Point(127, 17);
			this.txtPeriodo1DataCompetenciaFinal.MaxLength = 10;
			this.txtPeriodo1DataCompetenciaFinal.Name = "txtPeriodo1DataCompetenciaFinal";
			this.txtPeriodo1DataCompetenciaFinal.Size = new System.Drawing.Size(91, 23);
			this.txtPeriodo1DataCompetenciaFinal.TabIndex = 1;
			this.txtPeriodo1DataCompetenciaFinal.Text = "01/01/2000";
			this.txtPeriodo1DataCompetenciaFinal.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.txtPeriodo1DataCompetenciaFinal.Enter += new System.EventHandler(this.txtPeriodo1DataCompetenciaFinal_Enter);
			this.txtPeriodo1DataCompetenciaFinal.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPeriodo1DataCompetenciaFinal_KeyDown);
			this.txtPeriodo1DataCompetenciaFinal.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtPeriodo1DataCompetenciaFinal_KeyPress);
			this.txtPeriodo1DataCompetenciaFinal.Leave += new System.EventHandler(this.txtPeriodo1DataCompetenciaFinal_Leave);
			// 
			// txtPeriodo1DataCompetenciaInicial
			// 
			this.txtPeriodo1DataCompetenciaInicial.Font = new System.Drawing.Font("Microsoft Sans Serif", 10F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
			this.txtPeriodo1DataCompetenciaInicial.Location = new System.Drawing.Point(10, 17);
			this.txtPeriodo1DataCompetenciaInicial.MaxLength = 10;
			this.txtPeriodo1DataCompetenciaInicial.Name = "txtPeriodo1DataCompetenciaInicial";
			this.txtPeriodo1DataCompetenciaInicial.Size = new System.Drawing.Size(91, 23);
			this.txtPeriodo1DataCompetenciaInicial.TabIndex = 0;
			this.txtPeriodo1DataCompetenciaInicial.Text = "01/01/2000";
			this.txtPeriodo1DataCompetenciaInicial.TextAlign = System.Windows.Forms.HorizontalAlignment.Center;
			this.txtPeriodo1DataCompetenciaInicial.Enter += new System.EventHandler(this.txtPeriodo1DataCompetenciaInicial_Enter);
			this.txtPeriodo1DataCompetenciaInicial.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtPeriodo1DataCompetenciaInicial_KeyDown);
			this.txtPeriodo1DataCompetenciaInicial.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtPeriodo1DataCompetenciaInicial_KeyPress);
			this.txtPeriodo1DataCompetenciaInicial.Leave += new System.EventHandler(this.txtPeriodo1DataCompetenciaInicial_Leave);
			// 
			...
			this.txtMesCompetenciaFinal.Location = new System.Drawing.Point(221, 217);
			...
			this.txtMesCompetenciaFinal.TabIndex = 2;
			...
			this.lblTitPeriodoComp2.Location = new System.Drawing.Point(53, 222);
			...
			this.txtMesCompetenciaInicial.Location = new System.Drawing.Point(104, 217);
			...
			this.txtMesCompetenciaInicial.TabIndex = 1;
			...
			this.lblMesCompetenciaAte.Location = new System.Drawing.Point(201, 222);
			...
			this.chkCNPJ.Location = new System.Drawing.Point(447, 415);
			this.chkCNPJ.Name = "chkCNPJ";
			this.chkCNPJ.Size = new System.Drawing.Size(57, 17);
			this.chkCNPJ.TabIndex = 17;
			...
			this.chkCPF.Location = new System.Drawing.Point(377, 415);
			this.chkCPF.Name = "chkCPF";
			this.chkCPF.Size = new System.Drawing.Size(49, 17);
			this.chkCPF.TabIndex = 16;
			...
			this.cbPlanoContasGrupoFinal.Location = new System.Drawing.Point(605, 375);
			...
			this.cbPlanoContasGrupoFinal.TabIndex = 14;
			...
			this.lblTitPlanoContasGrupoFinal.Location = new System.Drawing.Point(522, 380);
			...
			this.cbPlanoContasGrupoInicial.Location = new System.Drawing.Point(104, 375);
			...
			this.cbPlanoContasGrupoInicial.TabIndex = 13;
			...
			this.lblTitPlanoContasGrupoInicial.Location = new System.Drawing.Point(12, 380);
			...
			this.txtCnpjCpf.Location = new System.Drawing.Point(359, 256);
			...
			this.lblCnpjCpf.Location = new System.Drawing.Point(286, 261);
			...
			this.txtValor.Location = new System.Drawing.Point(104, 256);
			...
			this.txtDescricao.Location = new System.Drawing.Point(605, 256);
			...
			this.lblDescricao.Location = new System.Drawing.Point(535, 261);
			...
			this.lblValor.Location = new System.Drawing.Point(34, 261);
			...
			this.cbPlanoContasConta.Location = new System.Drawing.Point(605, 335);
			...
			this.cbPlanoContasConta.TabIndex = 12;
			...
			this.lblTitPlanoContasConta.Location = new System.Drawing.Point(559, 340);
			...
			this.cbPlanoContasGrupo.Location = new System.Drawing.Point(104, 335);
			...
			this.cbPlanoContasGrupo.TabIndex = 11;
			...
			this.lblTitPlanoContasGrupo.Location = new System.Drawing.Point(57, 340);
			...
			this.cbPlanoContasEmpresa.Location = new System.Drawing.Point(605, 295);
			...
			this.cbPlanoContasEmpresa.TabIndex = 10;
			...
			this.lblPlanoContasEmpresa.Location = new System.Drawing.Point(544, 300);
			...
			this.cbContaCorrente.Location = new System.Drawing.Point(104, 295);
			...
			this.cbContaCorrente.TabIndex = 9;
			...
			this.lblTitContaCorrente.Location = new System.Drawing.Point(6, 300);
			...
			this.cbNatureza.Location = new System.Drawing.Point(898, 258);
			this.cbNatureza.Name = "cbNatureza";
			this.cbNatureza.Size = new System.Drawing.Size(107, 21);
			this.cbNatureza.TabIndex = 8;
			...
			this.lblTitNatureza.Location = new System.Drawing.Point(834, 261);
			...
			this.txtDataCadastroFinal.Location = new System.Drawing.Point(588, 217);
			...
			this.txtDataCadastroFinal.TabIndex = 4;
			...
			this.lblTitDataCadastro.Location = new System.Drawing.Point(374, 222);
			...
			this.txtDataCadastroInicial.Location = new System.Drawing.Point(471, 217);
			...
			this.txtDataCadastroInicial.TabIndex = 3;
			...
			this.lblTitDataCadastroA.Location = new System.Drawing.Point(568, 222);
			...
			this.lblTitPeriodoCompetencia.Location = new System.Drawing.Point(18, 31);
			...
			this.btnConsultar.Location = new System.Drawing.Point(834, 4);
			this.btnConsultar.Name = "btnConsultar";
			this.btnConsultar.Size = new System.Drawing.Size(40, 44);
			this.btnConsultar.TabIndex = 0;
			this.btnConsultar.TabStop = false;
			this.btnConsultar.UseVisualStyleBackColor = true;
			this.btnConsultar.Click += new System.EventHandler(this.btnConsultar_Click);
			// 
			// FFluxoRelatorioMovimentoSinteticoComparativo
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.ClientSize = new System.Drawing.Size(1018, 596);
			this.KeyPreview = true;
			this.Name = "FFluxoRelatorioMovimentoSinteticoComparativo";
			...
			this.gbCompetencia.PerformLayout();
			this.gbCompetenciaComparativoMensal.ResumeLayout(false);
			this.gbCompetenciaComparativoMensalFim.ResumeLayout(false);
			this.gbCompetenciaComparativoMensalInicio.ResumeLayout(false);
			this.gbCompetenciaComparativoEntrePeriodos.ResumeLayout(false);
			this.gbCompetenciaPeriodo2.ResumeLayout(false);
			this.gbCompetenciaPeriodo2.PerformLayout();
			this.gbCompetenciaPeriodo1.ResumeLayout(false);
			this.gbCompetenciaPeriodo1.PerformLayout();
		...
		private System.Windows.Forms.GroupBox gbCompetenciaComparativoEntrePeriodos;
		private System.Windows.Forms.GroupBox gbCompetenciaPeriodo2;
		private System.Windows.Forms.TextBox txtPeriodo2DataCompetenciaFinal;
		private System.Windows.Forms.TextBox txtPeriodo2DataCompetenciaInicial;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.GroupBox gbCompetenciaPeriodo1;
		private System.Windows.Forms.TextBox txtPeriodo1DataCompetenciaFinal;
		private System.Windows.Forms.TextBox txtPeriodo1DataCompetenciaInicial;
		private System.Windows.Forms.Label lblDataCompetenciaAte;
		private System.Windows.Forms.GroupBox gbCompetenciaComparativoMensal;
		private System.Windows.Forms.RadioButton rbCompetenciaComparativoEntrePeriodos;
		private System.Windows.Forms.RadioButton rbCompetenciaComparativoMensal;
		private System.Windows.Forms.GroupBox gbCompetenciaComparativoMensalInicio;
		private System.Windows.Forms.GroupBox gbCompetenciaComparativoMensalFim;
		private System.Windows.Forms.ComboBox cbCompetenciaMesInicial;
		private System.Windows.Forms.ComboBox cbCompetenciaAnoInicial;
		private System.Windows.Forms.ComboBox cbCompetenciaAnoFinal;
		private System.Windows.Forms.ComboBox cbCompetenciaMesFinal;
	}
}

...
namespace FinanceiroService
{
	class PedidoDAO
	{
		...
		public static Pedido getPedido(String numeroPedido)
		{
			...
			flagPedidoUsarMemorizacaoCompletaEnderecos = GeralDAO.getCampoInteiroTabelaParametro(Global.Cte.FIN.ID_T_PARAMETRO.ID_PARAMETRO_FLAG_PEDIDO_MEMORIZACAOCOMPLETAENDERECOS, 0);
			#endregion

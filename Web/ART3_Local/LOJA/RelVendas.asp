...
<!--  PEDIDO  -->
	...
	<br>
		<input maxlength="10" class="PLLe" style="width:100px;" name="c_pedido" id="c_pedido" onblur="if (normaliza_num_pedido(this.value)!='') this.value=normaliza_num_pedido(this.value);" onkeypress="if (digitou_enter(true)) bCONFIRMA.focus(); filtra_pedido();">
		</td></tr>
</table>

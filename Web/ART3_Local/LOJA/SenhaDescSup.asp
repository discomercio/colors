...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_CADASTRA_SENHA_DESCONTO, s_lista_operacoes_permitidas) then 
		cn.Close
...
<body onload="fFILTRO.c_fabricante[0].focus();">
<center>
...
<!--  AUTORIZADO POR  -->
	<tr bgColor="#FFFFFF">
		...
		<br>
		<select id="c_supervisor_autorizador" name="c_supervisor_autorizador" style="width:490px;" onchange="fFILTRO.c_fabricante[0].focus();">
		  <% =autorizador_desconto_cadastrado_na_loja_monta_itens_select(loja, "") %>
		</select>
		</td>
	</tr>
</table>

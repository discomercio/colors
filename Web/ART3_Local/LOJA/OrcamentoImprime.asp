...
var s;
	if (!( "object" == typeof(printer) && "string" == typeof(printer.module_id))) {
		s = "Componente necessário para impressão do Pré-Pedido não foi carregado corretamente!!";
		alert(s);
		return false;
		}
	return true;
...
"var cx, cy, cw, offx, offy, margemx, margemy, campo;" & chr(13) & _
	...
	"printer.job_title='Pré-Pedido " & orcamento_selecionado & "';" & chr(13) & _
...
s_script = s_script & _
	...
	"alert('Pré-Pedido " & orcamento_selecionado & " foi impresso!!');" & chr(13) & _
	"}" & chr(13) & _
	"</script>" & chr(13)
...
%>
	...
	<td width="145" class="MD"><p class="Rf">ORÇAMENTISTA</p><p class="C"><%=r_orcamento.orcamentista%>&nbsp;</p></td>
...
<tr>
	...
	<td align="right"><div name="dIMPRIME" id="dIMPRIME">
		<a name="bIMPRIME" id="bIMPRIME" href="javascript:fORCImprime(fORC)" title="imprime o pré-pedido em formulário contínuo">

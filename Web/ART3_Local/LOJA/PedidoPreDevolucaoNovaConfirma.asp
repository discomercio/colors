...
'	REVISADO P/ IE10
	...
	dim s, usuario, pedido_selecionado, loja, id_pedido_base
...
'	=========================
	...
	'	~~~~~~~~~~~~~
        ...
        if rs.Eof then
            ...
            rs("taxa_flag") = c_taxa
            if (c_taxa = TAXA_ADMINISTRATIVA__SIM) Or (Trim(c_taxa_observacoes) <> "") then
	...
	'	=================================
		if alerta = "" then
			...
			grava_log usuario, loja, pedido_selecionado, "", OP_LOG_PEDIDO_DEVOLUCAO, s_log
		'	~~~~~~~~~~~~~~
			cn.CommitTrans
		'	~~~~~~~~~~~~~~
			if Err=0 then 

...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_REL_VENDAS_COM_DESCONTO_SUPERIOR, s_lista_operacoes_permitidas) then 
		cn.Close
...
dim qtde_pedidos, n_reg, n_reg_total
	...
	s_sql = "SELECT" & _
				...
				" t_PEDIDO.pedido," & _
				" t_PEDIDO.vendedor," & _
				" abaixo_min_autorizador," & _
				" abaixo_min_superv_autorizador," & _
				" qtde," & _
				" fabricante," & _
				" produto," &_
				" descricao," & _
			...
			" WHERE" & _
				...
				" AND (abaixo_min_status <> 0)" & _
				" AND (CONVERT(smallint, t_PEDIDO.loja) = " & loja & ")"

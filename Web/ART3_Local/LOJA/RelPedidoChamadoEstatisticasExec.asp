...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_REL_ESTATISTICAS_PEDIDO_CHAMADO, s_lista_operacoes_permitidas) then 
		cn.Close
    ...
    if Not operacao_permitida(OP_LJA_PEDIDO_CHAMADO_CONSULTA_CHAMADOS_TODOS_DEPTOS, s_lista_operacoes_permitidas) And _

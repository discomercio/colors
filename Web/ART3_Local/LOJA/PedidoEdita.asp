...
<% else %>
	...
	<tr>
		<td class="MC" align="left" colspan="2"><p class="R">CONTRIBUINTE ICMS</p><p class="C">
			...
			<input type="radio" id="rb_contribuinte_icms_nao" name="rb_contribuinte_icms" value="<%=COD_ST_CLIENTE_CONTRIBUINTE_ICMS_NAO%>" <%=s%>  <%=strAtributosRadioboxDadosCadastrais%> ><span class="C" style="cursor:default" onclick="fPED.rb_contribuinte_icms[1].click();">Não</span>
				<%
                    s = " "
...
%>
	...
	<table width="649" class="QS" cellspacing="0">
	    ...
	    <tr>
		    <td width="50%" class="MD" align="left"><p class="Rf">UF</p><input id="endereco__uf" name="endereco__uf" class="TA" maxlength="2" size="3" onkeypress="if (digitou_enter(true) && tem_info(this.value) && uf_ok(this.value)) fPED.endereco__cep.focus();" onblur="this.value=trim(this.value); if (!uf_ok(this.value)) {alert('UF inválida!!');this.focus();} else this.value=ucase(this.value);" value="<%=cliente__uf%>" <%=strAtributosDadosCadastrais%> ></td>
		    <td>
				...
				<td width="100%">
					<table width="100%" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="MD" align="left" valign="top" nowrap width="20%"><p class="Rf">Número Magento</p>
     ...
     set cn2 = nothing%>
			...
			<tr>
				<td width="100%">
					<table width="100%" cellspacing="0" cellpadding="0">
						<tr>
							<td class="MC MD" align="left" nowrap width="33.3%"><p class="Rf">Nº Nota Fiscal</p>

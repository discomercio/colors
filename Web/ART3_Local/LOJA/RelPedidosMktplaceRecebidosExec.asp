...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_REL_REGISTRO_PEDIDO_MARKETPLACE_RECEBIDO_CLIENTE, s_lista_operacoes_permitidas) then 
		cn.Close
...
'	MONTA SQL DE CONSULTA
	...
	if blnActivatedFlagPedidoUsarMemorizacaoCompletaEnderecos then
		s_sql = s_sql & _
	           " ,p.endereco_cidade" & _
	           " ,p.endereco_uf" & _
	           " ,p.endereco_nome_iniciais_em_maiusculas"
	else
		s_sql = s_sql & _
	           " ,c.cidade" & _
	           " ,c.uf" & _

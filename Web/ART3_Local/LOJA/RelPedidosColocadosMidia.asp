...
<%
'     ========================================================
'	  R E L P E D I D O S C O L O C A D O S M I D I A . A S P
'     ========================================================
'
'
...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelPedidosColocadosMidiaExec.asp">
...
<!--  GRUPO DE PRODUTOS  -->
	...
	<br>
		<input maxlength="2" class="PLLe" style="width:60px;" name="c_grupo" id="c_grupo" onkeypress="if (digitou_enter(true)) bCONFIRMA.focus();" onblur="this.value=ucase(this.value);">
		</td></tr>

...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_REL_PEDIDOS_COLOCADOS_NO_MES, s_lista_operacoes_permitidas) then 
		cn.Close
...
<body onload="fFILTRO.c_mes.focus();">
<center>
...
<table class="Qx" cellSpacing="0">
	<tr bgColor="#FFFFFF">
	<td class="MT" align="left" NOWRAP><span class="PLTc">MÊS DE REFERÊNCIA</span>
	<br>
		...
		<span class="PLLc" style="color:#808080;">&nbsp;Mês</span
			...
			><input class="PLBc" maxlength="4" style="width:40px;" name="c_ano" id="c_ano" onblur="if (converte_numero(this.value)<2003) {alert('Ano inválido!'); this.focus();}" onkeypress="if (digitou_enter(true)&&tem_info(this.value)) bCONFIRMA.focus(); filtra_numerico();"

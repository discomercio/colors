		  ...
		  <td class="MT" align="center" nowrap>
			<table cellspacing="0" cellpadding="0" style='margin: 12px 8px 12px 8px;'>
			  ...
			  <tr>
				...
				<td><br><span id="txtEscolhidos" name="txtEscolhidos" class="C" style="margin:1px 10px 6px 10px;">Cidades Selecionadas</span>
					<br>
			...
			<table cellspacing="0" cellpadding="0" style='margin: 12px 8px 12px 8px;'>
			  <tr bgcolor="#FFFFFF">
				...
				<table><tr><td>
				  ...
				  <a href="javascript: CarregaCidadeBairro();" title="Pesquisa os bairros da UF selecionada"><img style="border:0" src="../IMAGEM/lupa_20x20.jpg" /></a>
				</td></tr></table></td>
				<td>
				  &nbsp;
				</td>
			  ...
			  <tr>
				<td align="left">
				  ...
				  <a href="javascript: CarregaBairro();" title="Pesquisa os bairros da cidade selecionada"><img style="border:0" src="../IMAGEM/lupa_20x20.jpg" /></a>
				</td>
			  </tr>
			  <tr><td>
			      &nbsp;
			  ...
			  <tr>
				...
				<td>
				  <input type="button" id="btnAddBairro" name="btnAddBairro" style="width:40px; margin-bottom:2px;" value="&gt;&gt;" />
					<br />
				    <input type="button" id="btnRmvBairro" name="btnRmvBairro" style="width:40px; margin-bottom:2px;" value="&lt;&lt;" />
				</td>
				<td>
			  ...
			  <tr bgcolor="#FFFFFF">
				...
				<td>
					<select id="c_indicador" name="c_indicador" style="margin-right:10px;width:480px;" 
						onkeyup="if (window.event.keyCode==KEYCODE_DELETE) this.options[0].selected=true;"
						onfocus="if (strListaIndicadoresUltimaLojaPesquisada!=trim(loja) && this.value =='') CarregaListaIndicadores(loja);"
			  ...
			  <tr bgcolor="#FFFFFF">
				...
				<td>
					<select id="c_vendedor" name="c_vendedor" style="margin-right:10px;width:480px;" 
						onkeyup="if (window.event.keyCode==KEYCODE_DELETE) this.options[0].selected=true;"
						onfocus="if (strListaVendedoresUltimaLojaPesquisada!=trim(loja) && this.value =='') CarregaListaVendedores(loja);"

...
'	PARÂMETROS DE PESQUISA
	...
	if cliente_unico_encontrado<>"" then
		Response.Redirect("clienteedita.asp?cliente_selecionado=" & cliente_unico_encontrado & "&operacao_selecionada=" & OP_CONSULTA & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")))
		end if

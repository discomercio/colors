...
<%
'     =================================================================
'	  RelPedidosCredPendVendasExec.asp
'     =================================================================
'
'
...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_LJA_REL_PEDIDOS_CREDITO_PENDENTE_VENDAS, s_lista_operacoes_permitidas) then 
		cn.Close
...
'	CRITÉRIO: ANÁLISE DE CRÉDITO PENDENTE VENDAS
	s = " analise_credito = " & COD_AN_CREDITO_PENDENTE_VENDAS
...
'	MONTA CLÁUSULA FROM
	...
	s_sql = "SELECT t_PEDIDO.loja, t_PEDIDO.numero_loja," & _
			" t_PEDIDO.data, t_PEDIDO.pedido, t_PEDIDO.vl_total_familia, t_CLIENTE.nome_iniciais_em_maiusculas," & _
			" t_PEDIDO.vendedor" & _
			s_from & _
			s_where
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Relatório de Pedidos com Crédito Pendente Vendas</span>
	<br><span class="Rc">

...
'	REVISADO P/ IE10
	...
	dim usuario, loja, pedido_selecionado, id_chamado
	...
	if Not operacao_permitida(OP_LJA_PEDIDO_CHAMADO_ESCREVER_MSG_QUALQUER_CHAMADO, s_lista_operacoes_permitidas) And _

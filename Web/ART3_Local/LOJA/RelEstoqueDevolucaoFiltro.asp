...
<!--  VENDEDOR  -->
	...
	<br>
		<input maxlength="10" class="PLLe" style="width:100px;" name="c_vendedor" id="c_vendedor" onblur="this.value=trim(this.value);" onkeypress="if (digitou_enter(true)) this.value=trim(this.value); filtra_nome_identificador();">
		</td></tr>

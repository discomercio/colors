			...
			with v_item(intCounter)
				...
				if blnTemItem then
					...
					elseif (.perc_desconto > perc_max_desconto_cadastrado_na_loja) then
						alerta=texto_add_br(alerta)
						alerta=alerta & "Percentual de desconto de " & formata_perc_desc(.perc_desconto) & "% para o produto '" & .produto & "' excede o máximo permitido para cadastramento na loja."
						end if

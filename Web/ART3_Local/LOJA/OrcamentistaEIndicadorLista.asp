...
dim r
  ...
  ' CABEÇALHO
	...
	cab=cab & "<TD width='90' nowrap class='MD MB MC' valign='bottom'><P class='R' style='cursor: pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='OrcamentistaEIndicadorLista.asp?ord=1" & s_op & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Identificação</P></TD>"

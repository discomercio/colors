...
'	ALTERA A SENHA NO BD
	if alerta = "" then 
		...
		if Not r.eof then 
			...
			r.Update
			If Err = 0 then 
				grava_log usuario, loja, "", "", OP_LOG_SENHA_ALTERACAO, "SENHA ALTERADA PELO USUÁRIO"
			else
...
<tr>
	<td align="right" valign="bottom"><p class="PEDIDO"><%=x_loja_e_cod(loja)%><br><span class="C">&nbsp;</span></p></td>
</tr>
</table>

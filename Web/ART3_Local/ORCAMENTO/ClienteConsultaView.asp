...
<%if eh_cpf then%>
	<td class="MD" align="left">
		<p class="R">RG</p>
		<p class="C">
		<input id="rg" name="rg" class="TA" type="text" maxlength="20" size="22" value="<%=Trim("" & rs("rg"))%>" readonly>
		</p>
	</td>
	<td class="MD" align="left">
		<p class="R">NASCIMENTO</p>
		<p class="C">
		<input id="dt_nasc" name="dt_nasc" class="TA" type="text" maxlength="10" size="14" value="<%=formata_data(rs("dt_nasc"))%>" readonly>
		</p>
	</td>
	<td align="left">
		<p class="R">SEXO</p>

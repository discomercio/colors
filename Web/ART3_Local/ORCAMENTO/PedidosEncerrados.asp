...
<%
'     =========================================
'	  P E D I D O S E N C E R R A D O S . A S P
'     =========================================
'
'
...
'	CRITÉRIO: ORÇAMENTISTA (CADA ORÇAMENTISTA SÓ PODE CONSULTAR PEDIDOS ORIGINADOS DE SEUS ORÇAMENTOS)
	s = "(t_PEDIDO.indicador = '" & usuario & "')"
	if s_where <> "" then s_where = s_where & " AND"
	s_where = s_where & " (" & s & ")"
	
'	CRITÉRIO: PEDIDOS ENCERRADOS (CANCELADOS OU ENTREGUES)
	s = "(t_PEDIDO.st_entrega = '" & ST_ENTREGA_ENTREGUE & "' OR t_PEDIDO.st_entrega = '" & ST_ENTREGA_CANCELADO & "')"
	if s_where <> "" then s_where = s_where & " AND"
	s_where = s_where & " (" & s & ")"
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Pedidos Encerrados</span>
	<br><span class="Rc">

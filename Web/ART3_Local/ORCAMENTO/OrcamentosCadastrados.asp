...
<%
'     =================================================================
'	  O R C A M E N T O S C A D A S T R A D O S . A S P
'     =================================================================
'
'
...
'	MONTA CLÁUSULA FROM
	...
	s_sql = "SELECT t_ORCAMENTO.loja, CONVERT(smallint,t_ORCAMENTO.loja) AS numero_loja," & _
			" t_ORCAMENTO.data, t_ORCAMENTO.orcamento, t_ORCAMENTO.vl_total, t_CLIENTE.nome_iniciais_em_maiusculas" & _
			s_from & _
			s_where
  ...
  ' MOSTRA AVISO DE QUE NÃO HÁ DADOS!!
	if n_reg_total = 0 then
		x = cab_table & cab
		x = x & "	<TR>" & chr(13) & _
				"		<TD class='MT' colspan='4'><P class='ALERTA'>&nbsp;NENHUM PRÉ-PEDIDO ENCONTRADO&nbsp;</P></TD>" & chr(13) & _
				"	</TR>" & chr(13)
		end if
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Pré-Pedidos Cadastrados</span>
	<br><span class="Rc">

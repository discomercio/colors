...
dim x, cab, n_reg, intLargCliente, s_cor
  ...
  ' CABEÇALHO
	cab = "<TABLE cellSpacing=0>" & chr(13) & _
		  ...
		  "		<TD class='MTD' valign='bottom' NOWRAP><P style='width:40px' class='Rc'>LOJA</P></TD>" & _
	...
	do while Not rs.Eof
	 ...
	 '> LOJA
		x = x & "		<TD align='center' valign='top' class='MTD'><P class='Cc'>" & Trim("" & rs("loja")) & "</P></TD>" & chr(13)
  ...
  ' MOSTRA TOTAL DE PEDIDOS
	if n_reg <> 0 then 
		x = x & "	<TR NOWRAP style='background: #FFFFDD'>" & chr(13) & _
				"		<TD COLSPAN='8' class='MT' NOWRAP><p class='C'>" & _

...
var s_dest, s_op;
	...
	if (f.rb_op[0].checked) {
		s_dest="FinCadUnidadeNegocioEdita.asp";
		s_op=OP_INCLUI;
		}
		
	if (f.rb_op[1].checked) {
		s_dest="FinCadUnidadeNegocioLista.asp";
		}
...
<span class="T">UNIDADES DE NEGÓCIO</span>
<div class="QFn" align="CENTER">
<table class="TFn">
	<tr>
		<td NOWRAP>
			<input type="RADIO" id="rb_op" name="rb_op" value="1" class="CBOX">
				<span style="cursor:default" onclick="fOP.rb_op[0].click(); fOP.bEXECUTAR.click();">Cadastrar Novo</span>&nbsp;
			<br>

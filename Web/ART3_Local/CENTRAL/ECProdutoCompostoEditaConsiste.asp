...
<%
'     =====================================
'	  ECProdutoCompostoEditaConsiste.asp
'     =====================================
'
'
...
' _____________________________________________________________________________________________
	...
	dim usuario, fabricante_selecionado, produto_selecionado, descricao_fornecida
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">E-Commerce: Edição de Produto Composto</span></td>
</tr>
</table>
<br>
...
<!--  CAMPOS DO CADASTRO  -->
<form id="fCAD" name="fCAD" method="post" action="ECProdutoCompostoEditaConfirma.asp">
...
<table width="649" class="Q" cellspacing="0">
	<tr>
		...
		<td width="70%" align="left"><p class="R">DESCRIÇÃO</p><p class="C"><input id="descricao_fornecida" name="descricao_fornecida" class="TA" type="text" maxlength="40" size="60" value="<%=descricao_fornecida%>" readonly tabindex=-1></p></td>
	</tr>
</table>
...
<tr>
	...
	<td align="right"><div name="dATUALIZA" id="dATUALIZA">
		<a name="bATUALIZA" href="javascript:AtualizaProdutoComposto(fCAD)" title="grava as alterações">

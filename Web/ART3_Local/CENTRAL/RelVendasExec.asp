...
<%
'     ======================================================
'	  R E L V E N D A S E X E C . A S P
'     ======================================================
'
'
...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_CEN_REL_FATURAMENTO, s_lista_operacoes_permitidas) then 
		cn.Close
...
'	DE 'QTDE' DE T_PEDIDO_ITEM.
	...
	s_sql = "SELECT t_ESTOQUE_MOVIMENTO.fabricante AS fabricante, t_ESTOQUE_MOVIMENTO.produto AS produto," & _
			...
			" Sum(t_ESTOQUE_MOVIMENTO.qtde*t_ESTOQUE_ITEM.preco_fabricante) AS valor_entrada" & _
...
'	CRIADOS VÁRIOS REGISTROS DE ESTOQUE A DIFERENTES CUSTOS DE AQUISIÇÃO.
	...
	s_sql = s_sql & " UNION " & _
			...
			" Sum(-t_ESTOQUE_ITEM.qtde*t_ESTOQUE_ITEM.preco_fabricante) AS valor_entrada" & _

...
<script type="text/javascript">
    ...
    function limpaCampoSelectUF() {
        $("#c_uf_pesq").children().prop('selected', false);
    }
    function selectAllCampoSelectUF() {
        $("#c_uf_pesq").children().prop('selected', true);
    }
</script>
...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelFaturamento3Exec.asp">
...
<!--  GRUPO DE PRODUTOS  -->
	...
	<br>
		<input maxlength="2" class="PLLe" style="width:60px;" name="c_grupo" id="c_grupo" onkeypress="if (digitou_enter(true)) fFILTRO.c_cst.focus();" onblur="this.value=ucase(this.value);">
		</td></tr>
...
<!--  CPF/CNPJ DO CLIENTE  -->
	<tr bgcolor="#FFFFFF">
		<td class="MDBE" align="left" nowrap><span class="PLTe">CNPJ/CPF DO CLIENTE</span>
		<br>
		  <span class="C" style="margin-left:30px;margin-bottom: 5px;">CNPJ/CPF</span>
...
<!--  UF DO CLIENTE  -->
	<tr bgcolor="#FFFFFF">
		...
		<br>
			...
			<tr bgcolor="#FFFFFF">
			<td align="left">
			<select id="c_uf_pesq" name="c_uf_pesq" style="width:100px;margin:1px 3px 6px 10px;" size="5" multiple
				onkeyup="if (window.event.keyCode==KEYCODE_DELETE) this.options[0].selected=true;"
		...
		<% =UF_monta_itens_select(Null) %>
            ...
            <td align="left" valign="top">
			<a href="javascript:limpaCampoSelectUF()" title="limpa o filtro 'UF do cliente'">
						<img src="../BOTAO/botao_x_red.gif" style="vertical-align:bottom;margin-bottom:1px;" width="20" height="20" border="0"></a>
			<br />
			<a href="javascript:selectAllCampoSelectUF()" title="seleciona todos os itens do filtro 'UF do cliente'">
						<img src="../BOTAO/check_all_green_20_x_20.png" style="vertical-align:bottom;margin-bottom:1px;" width="20" height="20" border="0"></a>
			</td>
			</tr>
			</table>
		</td>
...
<!-- EMPRESA -->
    <tr bgcolor="#FFFFFF">
		...
		<br>
			<select id="c_empresa" name="c_empresa" style="margin-left:30px;margin-bottom:4px;min-width:100px;" onkeyup="if (window.event.keyCode==KEYCODE_DELETE) this.options[0].selected=true;">
...
<!--  TIPO DE AGRUPAMENTO  -->
	...
	<td colspan="2" class="MDBE" NOWRAP><span class="PLTe">Tipo de Agrupamento</span>
		<div id="div_tipo_agrupamento_por_produto"><input type="radio" class="rbOpt rb_tipo_agrupamento" tabindex="-1" id="rb_tipo_agrupamento_por_produto" name="rb_tipo_agrupamento" value="<%=COD_TIPO_AGRUPAMENTO__PRODUTO%>" onclick="dCONFIRMA.style.visibility='';"><span class="C lblOpt" style="cursor:default" onclick="fFILTRO.rb_tipo_agrupamento[0].click();dCONFIRMA.style.visibility='';"
			>Produto</span>
        </div>
		<div id="div_tipo_agrupamento_por_grupo"><input type="radio" class="rbOpt rb_tipo_agrupamento" tabindex="-1" id="rb_tipo_agrupamento_por_grupo" name="rb_tipo_agrupamento" value="<%=COD_TIPO_AGRUPAMENTO__GRUPO%>" onclick="dCONFIRMA.style.visibility='';" checked><span class="C lblOpt" style="cursor:default" onclick="fFILTRO.rb_tipo_agrupamento[1].click();dCONFIRMA.style.visibility='';"

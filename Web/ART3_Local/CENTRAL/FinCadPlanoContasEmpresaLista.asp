...
<%
'     =====================================
'	  FinCadPlanoContasEmpresaLista.asp
'     =====================================
'
'
...
dim strTextoStatusInativo, strTextoStatusAtivo
  ...
  ' CABEÇALHO
	cab = _
			...
			"		<TD width='35' align='center' NOWRAP class='MD MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasEmpresaLista.asp?ord=1" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Id</P></TD>" & chr(13) & _
			"		<TD width='" & w_descricao & "' NOWRAP class='MD MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasEmpresaLista.asp?ord=2" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">&nbsp;Nome</P></TD>" & chr(13) & _
			"		<TD width='70' align='center' NOWRAP class='MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasEmpresaLista.asp?ord=3" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Status</P></TD>" & chr(13) & _
			"	</TR>" & chr(13)

	consulta = "SELECT * FROM t_FIN_PLANO_CONTAS_EMPRESA ORDER BY "
	select case ordenacao_selecionada
		case "1": consulta = consulta & "id"
		case "2": consulta = consulta & "descricao, id"
		case "3": consulta = consulta & "st_ativo, id"
	...
	while not r.eof 
	 ...
	 '> ID
		x = x & _
			...
			normaliza_codigo(r("id"),TAM_PLANO_CONTAS__EMPRESA) & "</a></P></TD>" & chr(13)
...
<tr>
	<td align="RIGHT" vAlign="BOTTOM" NOWRAP><span class="PEDIDO">Plano de Contas: Relação de Empresas Cadastradas</span>
	<br><span class="Rc">
...
<br>
<center>
<form METHOD="POST" ACTION="FinCadPlanoContasEmpresaEdita.asp" id="fOP" name="fOP">
...
<tr>
	<td align="CENTER"><a href="FinCadPlanoContasEmpresaMenu.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

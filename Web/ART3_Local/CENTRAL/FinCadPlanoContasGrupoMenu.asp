...
'     ================================
'	  FinCadPlanoContasGrupoMenu.asp
'     ================================
'
'
...
var s_dest, s_op, s_id;
	...
	if (f.rb_op[0].checked) {
		s_dest="FinCadPlanoContasGrupoEdita.asp";
		s_op=OP_INCLUI;
		s_id=f.c_novo.value;
		if (trim(f.c_novo.value)=="") {
			alert("Informe o código numérico para o novo grupo!!");
			f.c_novo.focus();
			return false;
			}
		}
	...
	if (f.rb_op[1].checked) {
		...
		if (trim(f.c_cons.value)=="") {
			alert("Informe o código numérico do grupo a ser consultado!!");
			f.c_cons.focus();
			return false;
			}
		}
	...
	if (f.rb_op[2].checked) {
		s_dest="FinCadPlanoContasGrupoLista.asp";
		}
...
<span class="T">PLANO DE CONTAS: CADASTRO DE GRUPO</span>
	...
	<tr>
		<td NOWRAP>
			<input type="RADIO" id="rb_op" name="rb_op" value="1" class="CBOX" onclick="fOP.c_novo.focus();">
				...
				<input name="c_novo" id="c_novo" type="TEXT" maxlength="<%=TAM_PLANO_CONTAS__GRUPO%>" size="6" 
					onblur="this.value=normaliza_codigo(this.value,TAM_PLANO_CONTAS__GRUPO);" 
			...
			<input type="RADIO" id="rb_op" name="rb_op" value="2" class="CBOX" onclick="fOP.c_cons.focus();">
				...
				<input name="c_cons" id="c_cons" type="TEXT" maxlength="<%=TAM_PLANO_CONTAS__GRUPO%>" size="6" 
					onblur="this.value=normaliza_codigo(this.value,TAM_PLANO_CONTAS__GRUPO);" 

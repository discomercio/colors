...
<!--  PERÍODO  -->
	<tr bgcolor="#FFFFFF">
		<td class="MT" align="center" nowrap style="background:azure;">
			<span class="PLTe">PERÍODO</span>
		</td>
	</tr>
	<tr bgcolor="#FFFFFF">
			...
			<table style="margin: 4px 8px 4px 8px;" cellspacing="0" cellpadding="0">
				<tr bgcolor="#FFFFFF">
					<td align="left" valign="bottom">
						<input size="10" class="Cc" maxlength="10" name="c_dt_inicio" id="c_dt_inicio"
							onblur="if (!isDate(this)) {alert('Data de início inválida!'); this.focus();}"
							onkeypress="if (digitou_enter(true)&&tem_info(this.value)&&isDate(this)) fFILTRO.c_dt_termino.focus(); filtra_data();">
						&nbsp;<span class="C">&nbsp;até&nbsp;</span>&nbsp;
						<input class="Cc" size="10" maxlength="10" name="c_dt_termino" id="c_dt_termino"
							onblur="if (!isDate(this)) {alert('Data de término inválida!'); this.focus();}"
							onkeypress="if (digitou_enter(true)&&tem_info(this.value)&&isDate(this)) bCONFIRMA.focus(); filtra_data();">
					</td>
				</tr>
			</table>
		</td>

...
%>
	...
	<td width="145" class="MD" align="left">
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr>
			<td><p class="Rf">INDICADOR</p><a href='javascript:fOrcamentistaEIndicadorConsultaView(<%=chr(34) & r_pedido.indicador & chr(34)%>)' title="clique para consultar o cadastro do indicador"><p class="C"><%=strTextoIndicador%>&nbsp;</p></a></td>
...
<%  notPrint = ""
		...
		<td width="100%">
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td class="MB" nowrap align="left" valign="top" width="20%"><p class="Rf">Garantia Indicador</p>
					<% 	if Cstr(r_pedido.GarantiaIndicadorStatus) = Cstr(COD_GARANTIA_INDICADOR_STATUS__NAO) then
							s = "NÃO"
						elseif Cstr(r_pedido.GarantiaIndicadorStatus) = Cstr(COD_GARANTIA_INDICADOR_STATUS__SIM) then
							s = "SIM"
	...
	<tr>
		<td width="100%">
			<table width="100%" cellspacing="0" cellpadding="0">
				<tr>
					<td class="MD" nowrap align="left" width="33.3%"><p class="Rf">Nº Nota Fiscal</p>
					...
					<td class="MD" nowrap align="left" width="33.3%"><p class="Rf">NF Simples Remessa</p>

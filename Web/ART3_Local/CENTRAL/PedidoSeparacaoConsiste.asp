...
<%
'     =====================================================
'	  P E D I D O S E P A R A C A O C O N S I S T E . A S P
'     =====================================================
'
'
...
<form id="fSEP" name="fSEP" method="post" action="pedidoseparacaoconfirma.asp">
...
<tr>
	<td align="right" valign="bottom"><p class="PEDIDO">Separação de Mercadorias para Entrega<span class="C">&nbsp;</span></p></td>
</tr>
</table>
<br>
...
<table class="Qx" cellSpacing="0">
	<tr bgColor="#FFFFFF">
		<td class="MT" style='background:azure;' NOWRAP><span class="PLTe">Nº Pedido(s)&nbsp;</span></td>
	</tr>
<% for i=Lbound(v_pedido) to Ubound(v_pedido) 
		if v_pedido(i) <> "" then %>
			<tr bgColor="#FFFFFF">

...
<script language="JavaScript" type="text/javascript">
    ...
    function fPEDChamadoNovoConfirma(f) {
        ...
        s = "" + f.c_texto.value;
            if (s.length == 0) {
                alert('É necessário escrever o texto descrevendo o chamado!!');
                f.c_texto.focus();
                return;
            }
...
<tr>
	...
	<table class="Q" style="width:649px;" cellSpacing="0">
        ...
        <p class="Rf">DEPARTAMENTO RESPONSÁVEL</p>
        <p class="C">
...
<tr>
	<td>
	    <table id="table_descricao" class="Q" style="width:649px;margin:0" cellSpacing="0">
		    <tr>
			    <td>
                    <p class="Rf">DESCRIÇÃO DO CHAMADO</p>
    ...
    <tr>
	<td align="left" valign="bottom" style="border: 1pt solid #C0C0C0;">
        <p class="Rf">NÍVEL DE ACESSO AO CHAMADO</p>
        <p class="C">

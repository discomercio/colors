...
<%
'     =================================================================
'	  P E D I D O E N T R E G A M A R C P A R A C O N F I R M A . A S P
'     =================================================================
'
'
...
'	REVISADO P/ IE10
	...
	dim s, usuario, msg_erro, s_log, s_dt_entrega, lista_pedidos, v_pedido, i, achou
...
'	=========================
	...
	'	~~~~~~~~~~~~~
			...
			if v_pedido(i) <> "" then
				...
				if rs.Eof then
					...
					if Not IsEntregaAgendavel(Trim("" & rs("st_entrega"))) then
						...
						rs("a_entregar_data_marcada")=StrToDate(s_dt_entrega)
		...
		if alerta = "" then
			s_log = "Data de coleta: " & s_dt_entrega & "; Pedido(s) = " & s_log

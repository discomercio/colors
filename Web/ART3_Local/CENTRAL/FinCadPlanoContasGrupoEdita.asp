...
<%
'     =====================================
'	  FinCadPlanoContasGrupoEdita.asp
'     =====================================
'
'
...
'	REGISTRO A EDITAR
	...
	id_selecionado=normaliza_codigo(id_selecionado, TAM_PLANO_CONTAS__GRUPO)
...
<tr>
<%	if operacao_selecionada=OP_INCLUI then
		s = "Plano de Contas: Cadastro de Novo Grupo"
	else
		s = "Plano de Contas: Consulta/Edição de Grupo"
		end if
%>
...
<!--  CAMPOS DO CADASTRO  -->
<form id="fCAD" name="fCAD" method="post" action="FinCadPlanoContasGrupoAtualiza.asp">

...
<%
'     ===========================================================
'	  E D I T A P A R A M G L O B A L N U M I N T E I R O . A S P
'     ===========================================================
'
'
...
'	CONECTA COM O BANCO DE DADOS
	...
	dim s, m_parametro
	dim strIdParametro, strTituloParametroGlobal, strTituloUnidadeMedida
	strTituloParametroGlobal = Trim(Request.Form("TituloParametroGlobal"))
	strIdParametro = Trim(Request.Form("IdParametro"))
	strTituloUnidadeMedida = Trim(Request.Form("TituloUnidadeMedida"))
...
<body onload="window.status='Concluído';fCAD.c_parametro.focus();" link=#000000 alink=#000000 vlink=#000000>
...
<br>
<center>
<form METHOD="POST" ACTION="EditaParamGlobalNumInteiroConfirma.asp" id="fCAD" name="fCAD">
<%=MontaCampoFormSessionCtrlInfo(Session("SessionCtrlInfo"))%>
<INPUT type=HIDDEN name='TituloParametroGlobal' id="TituloParametroGlobal" value='<%=strTituloParametroGlobal%>'>
<INPUT type=HIDDEN name='TituloUnidadeMedida' id="TituloUnidadeMedida" value='<%=strTituloUnidadeMedida%>'>
...
'	RECUPERA VALOR ANTERIOR
	...
	rs.open s, cn
	if Not rs.Eof then
		m_parametro = converte_numero(rs("nsu"))
	else
		m_parametro = 0
		end if
%>
...
<tr style="background:#FFF0E0">
	<td class="MT" colspan="2" align="center"><p class="Cc" style="font-size:10pt;">Valor do Parâmetro</p></td>
	</tr>
<tr>
	<td class="MEB" align="right">
		<input id="c_parametro" name="c_parametro" class="PLLd" style="font-size:10pt;vertical-align:bottom;" 
				value="<%=formata_inteiro(m_parametro)%>" 
				maxlength="18" 
				onkeypress="if (digitou_enter(true)) bATUALIZA.focus(); filtra_numerico();">
	</td>
	<td class="MDB" align="left">
		<span class="PLTe" style="font-size:10pt;vertical-align:bottom;">&nbsp;<%=strTituloUnidadeMedida%>&nbsp;</span>
	</td>
	</tr>
</table>

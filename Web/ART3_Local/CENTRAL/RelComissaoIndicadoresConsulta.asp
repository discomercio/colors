...
<form id="fFILTRO" name="fFILTRO" method="get" action="RelComissaoIndicadoresFinaliza.asp">
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Consulta Relação de Depósitos</span>
	<br><span class="Rc">

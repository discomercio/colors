...
'	RECUPERA OS FILTROS USADOS NA CONSULTA P/ QUE O RELATÓRIO POSSA SER REEXECUTADO AUTOMATICAMENTE
	...
	dim c_vendedor, c_indicador, c_captador, c_lista_loja	
	...
	'	~~~~~~~~~~~~~
		...
		'	~~~~~~~~~~~~~~
			...
			'	FILTROS USADOS NA CONSULTA
				s_url = "RelDevolucao2Exec.asp?origem=A" & _
						"&ckb_periodo_devolucao=" & ckb_periodo_devolucao & _
						"&c_dt_devolucao_inicio=" & c_dt_devolucao_inicio & _
						"&c_dt_devolucao_termino=" & c_dt_devolucao_termino & _

...
<%
'     =================================================================
'	  RelComissaoIndicadoresGravaDados.asp
'     =================================================================
'
'
...
'	=========================
	...
	'	~~~~~~~~~~~~~
		...
		if alerta = "" then
			...
			if s_log <> "" then
				s_log = "Edição do status de comissão paga/não-paga via 'Relatório de Pedidos Indicadores': Total registros atualizados = " & Cstr(qtde_total_reg_update) & " (Venda Normal: " & Cstr(qtde_venda_normal_update) & ", Devolução: " & Cstr(qtde_devolucao_update) & ", Perda: " & Cstr(qtde_perda_update) & ")" & chr(13) & s_log

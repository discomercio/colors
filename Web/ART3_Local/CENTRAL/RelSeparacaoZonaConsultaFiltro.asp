...
//  Período de consulta está restrito por perfil de acesso?
	...
	if (trim(f.c_nsu.value) == "") {
		if ((trim(f.c_dt_inicio.value) == "") || (trim(f.c_dt_termino.value) == "")) {
			alert("É necessário informar o período da consulta ou o NSU do relatório!!");
			return;
		}
	}
	...
	<tr bgcolor="#FFFFFF">
		<td align="left">
			<table style="margin: 4px 8px 4px 8px;" cellspacing="0" cellpadding="0">
				...
				<input class="Cc" maxlength="10" name="c_dt_termino" id="c_dt_termino" style="width:90px;" onblur="if (!isDate(this)) {alert('Data de término inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)&&tem_info(this.value)&&isDate(this)) fFILTRO.c_nsu.focus(); filtra_data();">
				</td>
				</tr>
			</table>
		</td>
...
<tr>
	...
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap>
			<span class="PLTe">NSU DO RELATÓRIO</span>
		</td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="left">

...
<%
'     ==========================================================================================
'	  R E L C O M I S S A O I N D I C A D O R E S P A G D E S C E X E C C O N F I R M A . A S P
'     ==========================================================================================
'
'
...
'	=========================
    ...
    dim vl_total_com_desc, vl_total_com_desc_arredondado, vl_total_RA_desc, vl_total_RA_desc_arredondado, vl_total_pagto_desc
    dim c_lista_total_comissao_arredondado_desc, c_lista_total_RA_arredondado_desc
    dim v_lista_total_comissao_arredondado_desc, v_lista_total_RA_arredondado_desc
    dim o
    ...
    c_lista_total_comissao_arredondado_desc = Trim(Request.Form("c_lst_com_a_desc"))
    c_lista_total_RA = Trim(Request.Form("c_lst_ra"))
    c_lista_total_RA_arredondado = Trim(Request.Form("c_lst_ra_a"))
    c_lista_total_RA_arredondado_desc = Trim(Request.Form("c_lst_ra_a_desc"))
    ...
    v_lista_total_comissao_arredondado_desc = split(c_lista_total_comissao_arredondado_desc, ";")
    v_lista_total_RA = split(c_lista_total_RA, ";")
    v_lista_total_RA_arredondado = split(c_lista_total_RA_arredondado, ";")
    v_lista_total_RA_arredondado_desc = split(c_lista_total_RA_arredondado_desc, ";")
        ...
        if Not rs2.Eof then
            if (vendedor_a <> Trim("" & rs2("vendedor"))) then
                ...
                if (indicador_a <> Trim("" & rs2("indicador"))) then
                    ...
                    vl_total_com_desc = converte_numero(v_lista_total_comissao(n)) - (converte_numero(v_lista_total_comissao(n)) * (COMISSAO_INDICADOR_PERC_DESCONTO_SEM_NF / 100))
                    'vl_total_com_desc_arredondado = floor(converte_numero(FormatNumber(v_lista_total_comissao(n), 2))) - (floor(converte_numero(FormatNumber(v_lista_total_comissao_arredondado(n), 2))) * (COMISSAO_INDICADOR_PERC_DESCONTO_SEM_NF / 100))
                    vl_total_RA_desc = converte_numero(v_lista_total_RA(n)) - (converte_numero(v_lista_total_RA(n)) * (COMISSAO_INDICADOR_PERC_DESCONTO_SEM_NF / 100))
                    'vl_total_RA_desc_arredondado = floor(converte_numero(v_lista_total_RA(n))) - (floor(converte_numero(v_lista_total_RA_arredondado(n))) * (COMISSAO_INDICADOR_PERC_DESCONTO_SEM_NF / 100))
                    'vl_total_com_desc_arredondado = o.digitoFinal(vl_total_com_desc_arredondado)
                    'vl_total_RA_desc_arredondado = o.digitoFinal(vl_total_RA_desc_arredondado)
                    vl_total_pagto_desc = converte_numero(v_lista_total_comissao_arredondado_desc(n)) + converte_numero(v_lista_total_RA_arredondado_desc(n))
                    ...
                    rs("vl_total_pagto") = converte_numero(v_lista_total_comissao_arredondado(n))+converte_numero(v_lista_total_RA_arredondado(n))
                    rs("st_NFS_fornecida") = 0
                    rs("perc_desc_comissao_ausencia_NFS") = converte_numero(COMISSAO_INDICADOR_PERC_DESCONTO_SEM_NF)
                    rs("vl_total_comissao_liquido_NFS") = converte_numero(FormatNumber(vl_total_com_desc))
                    rs("vl_total_comissao_liquido_arredondado_NFS") = converte_numero(FormatNumber(v_lista_total_comissao_arredondado_desc(n)))
                    rs("vl_total_RA_liquido_NFS") = converte_numero(FormatNumber(vl_total_RA_desc))
                    rs("vl_total_RA_liquido_arredondado_NFS") = floor(converte_numero(v_lista_total_RA_arredondado_desc(n)))
                    rs("vl_total_pagto_liquido_NFS") = vl_total_pagto_desc
    ...
    if Err=0 then Response.Redirect("RelComissaoIndicadoresDescFinaliza.asp?id=" & intNsuNovoComissaoN1 & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "&rb_visao=" & rb_visao)

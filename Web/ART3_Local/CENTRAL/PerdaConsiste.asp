...
'	=========================
	...
	'	OBTÉM OS VALORES A PAGAR, JÁ PAGO E O STATUS DE PAGAMENTO (PARA TODA A FAMÍLIA DE PEDIDOS)
		...
		if (m_valor + vl_TotalFamiliaDevolucaoPrecoNF + vl_perda) > vl_TotalFamiliaPrecoNF then
			...
			observacoes = observacoes & "O valor total em perdas e devoluções irá superar o valor do pedido."
			end if
		end if
...
<table class="Qx" cellSpacing="0">
	<tr bgColor="#FFFFFF">
		<td class="MT" NOWRAP><span class="PLTe">Valor Total da Família de Pedidos</span>

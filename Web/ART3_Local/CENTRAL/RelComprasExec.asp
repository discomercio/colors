...
dim valor_total, s_sql, cab, n_reg, x
	...
	s_sql = "SELECT" & _
				" e.fabricante," & _
				" Sum(qtde*preco_fabricante) AS valor" & _
	...
	if Trim(cod_fabricante) <> "" then
		s_sql = s_sql & " AND (i.fabricante = '" & cod_fabricante & "')"
		end if
...
dim strFabricanteAnterior, strFabricante, strProduto, intQtdeFabricantes
	...
	s_sql = "SELECT" & _
				...
				" Coalesce(Sum(qtde*preco_fabricante),0) AS valor" & _
			" FROM t_ESTOQUE e INNER JOIN t_ESTOQUE_ITEM i ON (e.id_estoque=i.id_estoque)" & _
			" WHERE" & _
				" (kit=0)" & _
				" AND (entrada_especial=0)" & _
...
dim strFabricanteAnterior, strFabricante, strProduto, intQtdeFabricantes
  ...
  ' CABEÇALHO
	...
	cab = _
		  ...
		  "		<TD valign='bottom' class='MDTE' NOWRAP><P style='width:300px' class='R'>PRODUTO</P></TD>" & chr(13) & _
		  "		<TD valign='bottom' class='MTD' NOWRAP ><P style='width:60px' class='Rd' style='font-weight:bold;'>QTDE</P></TD>" & chr(13) & _
		  "		<TD valign='bottom' class='MTD' NOWRAP ><P style='width:110px' class='Rd' style='font-weight:bold;'>CUSTO MÉDIO</P></TD>" & chr(13) & _
...
dim strFabricanteAnterior, strFabricante, strProduto, intQtdeFabricantes
	...
	s_sql = s_sql & " GROUP BY i.fabricante, i.produto, i.preco_fabricante" & _
					" ORDER BY i.fabricante, i.produto, i.preco_fabricante"
  ...
  ' CABEÇALHO
	...
	cab = _
		  ...
		  "		<TD valign='bottom' class='MDTE' NOWRAP><P style='width:300px' class='R'>PRODUTO</P></TD>" & chr(13) & _
		  "		<TD valign='bottom' class='MTD' NOWRAP><P style='width:60px' class='Rd' style='font-weight:bold;'>QTDE</P></TD>" & chr(13) & _
		  "		<TD valign='bottom' class='MTD'><P style='width:110px' class='Rd' style='font-weight:bold;'>CUSTO INDIVIDUAL</P></TD>" & chr(13) & _
		  "		<TD align='right' class='MTD' valign='bottom' NOWRAP ><P style='width:110px' class='Rd' style='font-weight:bold;'>TOTAL</P></TD>" & chr(13) & _
		  "	</TR>" & chr(13)
	...
	do while Not r.Eof
	 ...
	 '> CUSTO INDIVIDUAL
		vlAux = r("preco_fabricante")
		x = x & "		<TD class='MTD' valign='bottom'><P class='Cd'>&nbsp;" & formata_moeda(vlAux) & "</P></TD>" & chr(13)

	 '> VALOR
		vlAux = r("preco_fabricante")*r("qtde")
...
<!--  TIPO DE DETALHAMENTO  -->
	<tr bgColor="#FFFFFF">
		<% select case rb_detalhe
			...
			case "CUSTO_MEDIO":			s = "Valor Médio"
			case "CUSTO_INDIVIDUAL":	s = "Valor Individual"
			case else					s = ""
			end select
		%>

...
var s_dest, s_op, b;
	...
	if (f.rb_op[2].checked) {
		...
		if (trim(f.c_dt_corte.value)=="") {
			...
			alert("Data de corte é uma data inválida!!");
			f.c_dt_corte.focus();
			return;
			}

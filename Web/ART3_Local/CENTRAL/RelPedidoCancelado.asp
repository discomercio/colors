...
<td class="MDBE" align="left" nowrap><span class="PLTe">MOTIVO</span>
    ...
    <tr id="motivo_alternativo">
       <td align="right"><span class="C" style="margin-left:0px;">Sub-Motivo</span></td>
		<td align="left">
			<select id="c_cod_sub_motivo" name="c_cod_sub_motivo" style="margin-right:225px;margin-top:4px;" onchange="Teste(this.value);">			
...
<!--  LOJA  -->
    ...
    <td class="MDBE" NOWRAP><span class="PLTe">LOJA</span>
		<br><input name="c_loja" id="c_loja" class="PLLe" maxlength="3" style="margin-left:2pt;width:100px;" value=""  onkeypress="if (!digitou_enter(false) && !digitou_char('-')) filtra_numerico();" onblur="this.value=normaliza_lista_lojas(this.value);"></td>
    </tr>

...
<!--  CPF/CNPJ  -->
	<%  idx=idx+1 %>
	<input type="radio" id="rb_op" name="rb_op" value="<%=Cstr(idx)%>" class="CBOX" onclick="fFILTRO.c_cnpj_cpf.focus();">
...
<!--  NOME DO CLIENTE  -->
	...
	<%  idx=idx+1 %>
	<input type="radio" id="rb_op" name="rb_op" value="<%=Cstr(idx)%>" class="CBOX" onclick="fFILTRO.c_nome_completo.focus();">
...
<!--  PARTE DO NOME DO CLIENTE  -->
	...
	<td class="MDBE" NOWRAP>
	<%  idx=idx+1 %>
	<input type="radio" id="rb_op" name="rb_op" value="<%=Cstr(idx)%>" class="CBOX" onclick="fFILTRO.c_nome_parcial.focus();">
...
<tr>
	<td><a name="bVOLTAR" id="bVOLTAR" href="resumo.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página inicial">

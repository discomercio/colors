...
<!--  GRUPO DE PRODUTOS  -->
	...
	<br>
		<input maxlength="2" class="PLLe" style="width:60px;" name="c_grupo" id="c_grupo" onkeypress="if (digitou_enter(true)) fFILTRO.c_loja.focus();" onblur="this.value=ucase(this.value);">
		</td></tr>

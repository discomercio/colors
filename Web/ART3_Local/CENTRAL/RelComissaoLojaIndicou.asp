...
<%
'     ========================================================
'	  R E L C O M I S S A O L O J A I N D I C O U . A S P
'     ========================================================
'
'
...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelComissaoLojaIndicouExec.asp">
...
<table class="Qx" cellSpacing="0">
	...
	<br>
		...
		<input class="PLLc" maxlength="10" style="width:70px;" name="c_dt_inicio" id="c_dt_inicio" onblur="if (!isDate(this)) {alert('Data de início inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)) fFILTRO.c_dt_termino.focus(); filtra_data();"
			>&nbsp;<span class="PLLc" style="color:#808080;">&nbsp;até&nbsp;</span>&nbsp;<input class="PLLc" maxlength="10" style="width:70px;" name="c_dt_termino" id="c_dt_termino" onblur="if (!isDate(this)) {alert('Data de término inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)) fFILTRO.c_loja.focus(); filtra_data();">
			</td></tr>
		</table>
		</td></tr>

...
<tr>
	<td align="RIGHT" vAlign="BOTTOM" NOWRAP><span class="PEDIDO">Desconto Máximo Aceito Sem Zerar a Comissão</span>
	<br><span class="Rc">
...
<br>
<center>
<form METHOD="POST" ACTION="CadPercMaxDescSemZerarRTConfirma.asp" id="fCAD" name="fCAD">
...
<tr id="TR_<%=Cstr(n_reg)%>">
	...
	<td class="MB MD tdPerc" align="right"><input id="c_percentual" name="c_percentual" class="PLLd" style="font-size:10pt;width:70px;background-color:Transparent;" value="<%=formata_perc(rs("PercMaxDescSemZerarRT"))%>" maxlength="5" 

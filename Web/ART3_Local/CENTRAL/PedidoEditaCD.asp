...
' Usado para montar a lista de opções de novo CD para o pedido.
' A lista é montada de forma que:
'	1) Somente os CDs habilitados no perfil do usuário são exibidos
'	2) O CD que já está cadastrado no pedido não é exibido na lista
'	3) Se o pedido já possui NFe emitida, são exibidos como opções de novo CD somente aqueles que possuem o mesmo CNPJ que o CD atual
'
' Subsídios:
...
'
' Parâmetros:
'	id_usuario = ID do usuário, esta informação é usada para determinar os CDs habilitados em seu perfil
'	id_nfe_emitente_ignorado = ID do emitente que deve ser excluído da lista de opções, ou seja, o CD que já consta no pedido
'	cnpjMustBeEqual = se informado, são exibidos somente os CDs que possuam este CNPJ
...
<tr>
	<td align="left" valign="bottom"><span class="PEDIDO">Edição do CD</span></td>
...
<tr>
	<td><a name="bCANCELA" id="bCANCELA" href="javascript:history.back()" title="cancela a edição do CD">
		<img src="../botao/cancelar.gif" width="176" height="55" border="0"></a></td>
	<td align="right"><div name="dCONFIRMA" id="dCONFIRMA">
		<a name="bCONFIRMA" id="bCONFIRMA" href="javascript:fPedEditaCDConfirma(fPED)" title="grava a alteração do CD">

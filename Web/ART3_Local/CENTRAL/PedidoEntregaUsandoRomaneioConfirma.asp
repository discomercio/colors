...
<%
'     ========================================================
'	  PedidoEntregaUsandoRomaneioConfirma.asp
'     ========================================================
'
'
...
'	REVISADO P/ IE10
	...
	dim s, usuario, msg_erro, s_log, c_nsu_romaneio, c_qtde_pedidos, s_pedido, v_pedido, i, intQtdePedidos, intQtdePedidosSelecionados
...
'	=========================
	...
	'	~~~~~~~~~~~~~
		...
		if alerta = "" then
			s_log = "Entrega de Mercadorias usando dados do Romaneio (NSU=" & c_nsu_romaneio & "): " & s_log
			grava_log usuario, "", "", "", OP_LOG_PEDIDO_ENTREGUE, s_log
		'	~~~~~~~~~~~~~~
			cn.CommitTrans
		'	~~~~~~~~~~~~~~
			if Err=0 then 

...
<tr>
	<td align="right" valign="bottom" nowrap><span class="PEDIDO">Relação de Avisos Cadastrados</span>
	<br><span class="Rc">
...
<tr>
	<td align="center"><a href="quadroaviso.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

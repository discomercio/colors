...
<table width="649" class="QS" cellspacing="0">
    <tr>
		<td width="65%" align="left"><p class="R">FAVORECIDO</p><p class="C"><input id="favorecido" name="favorecido" class="TA" size="80" value="<%=rs("favorecido")%>" readonly tabindex=-1></p></td>
    </tr>
</table>
...
<table width="649" class="QS" cellspacing="0">
	<tr>
		<td class="MD" width="40%" align="left"><p class="R">CPF/CNPJ DO FAVORECIDO</p><p class="C"><input id="favorecido_cnpjcpf" name="favorecido_cnpjcpf" class="TA" readonly tabindex=-1 maxlength="18" size="25" value="<%=cnpj_cpf_formata(Trim("" & rs("favorecido_cnpj_cpf")))%>"></p></td>
<%
	senha_descripto= ""
	s = Trim("" & rs("datastamp"))

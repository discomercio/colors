...
<%
'     =================================================================
'	  RelComissaoIndicadoresPesquisaGravaDados.asp
'     =================================================================
'
'
...
'	FILTROS
    ...
    c_cnpj_cpf = Trim(Request.Form("c_cnpj_cpf"))
...
'	=========================
	...
	'	~~~~~~~~~~~~~
		...
		if alerta = "" then
			...
			if s_log <> "" then
				s_log = "Edição do status de comissão paga/não-paga via 'Comissão Indicadores: Pesquisa Indicador': Total registros atualizados = " & Cstr(qtde_total_reg_update) & " (Venda Normal: " & Cstr(qtde_venda_normal_update) & ", Devolução: " & Cstr(qtde_devolucao_update) & ", Perda: " & Cstr(qtde_perda_update) & ")" & chr(13) & s_log
...
<script language="JavaScript" type="text/javascript">
    function fAvisoVoltar(f) {
        f.action = "RelComissaoIndicadoresPesquisa.asp?url_back=X";
        f.submit();
    }
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Comissão Indicadores: Pesquisa Indicador</span></td>
</tr>
</table>
<br>
<br>
...
<div class='MtAviso' style="width:649px;font-weight:bold;border:1pt solid black;" align="center">
    <span style='margin:5px 2px 5px 2px;'>CNPJ/CPF: <%=cnpj_cpf_formata(c_cnpj_cpf)%></span>
    <br /><br />

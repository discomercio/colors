...
<%
'     =========================================================================
'	  RelCubagemVolumePesoSinteticoExec.asp
'     =========================================================================
'
'
...
'	CRITÉRIOS: DATA DE COLETA (RÓTULO ANTIGO: ENTREGA MARCADA PARA)
	if IsDate(c_dt_entrega_marcada_para) then
		s_where = s_where & " (t_PEDIDO.a_entregar_data_marcada = " & bd_formata_data(StrToDate(c_dt_entrega_marcada_para)) & ")"
		end if
...
<% 
	...
	s = Trim(c_dt_entrega_marcada_para)
	if s = "" then s = "Todas"
	s_filtro = s_filtro & "<tr><td align='right' valign='top' nowrap>" & _
			   "<span class='N'>Data de coleta:&nbsp;</span></td><td align='left' valign='top' width='99%'>" & _

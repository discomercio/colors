...
<%
'     ==============================================================================
'	  CreditoOkDepositoAguardandoDesbloqueioConsiste.asp
'     ==============================================================================
'
'
		...
		for i = Lbound(v_pedido) to Ubound(v_pedido)
			if v_pedido(i) <> "" then
				...
				if rs.Eof then
					...
					if Cstr(rs("analise_credito")) <> Cstr(COD_AN_CREDITO_OK_DEPOSITO_AGUARDANDO_DESBLOQUEIO) then
						alerta=texto_add_br(alerta)
...
function fDepDesbloqCrOkConfirma( f ) {
...
<form id="fDepDesbloqCrOk" name="fDepDesbloqCrOk" method="post" action="CreditoOkDepositoAguardandoDesbloqueioConfirma.asp">
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Crédito OK (depósito aguardando desbloqueio)</span></td>
</tr>
</table>
<br>
...
<tr>
	...
	<a name="bCONFIRMA" id="bCONFIRMA" href="javascript:fDepDesbloqCrOkConfirma(fDepDesbloqCrOk)" title="confirma o desbloqueio do depósito">

...
dim textDin,sub_total_com_RT,sub_total_com_RA,sub_total_com,sub_total_com_desc,contador,v_desconto_descricao(),v_desconto_valor(),qtde_registro_desc,valor_desconto
  ...
  ' CABEÇALHO
    ...
    if aviso = "" then
		    ...
		    if Trim("" & r("ind3"))<>indicador_a then
              ...
              ' SOMATORIA DO MEIOS DE PAGAMENTO CHECADOS
                ...
                'SUB TOTAL COMISSÃO
                    ...
                    x = x & "</tr>" & chr(13) 
                    if sub_total_comissao >= 0 then
                        x = x & "<td align='right' colspan='11'><span class='Cd' style='color:gray;'>Sem desconto: " & formata_moeda(sub_total_com_desc) & "</span></td>" & chr(13)
                    end if
                    if msg_desconto <> "" then
                        x = x &"   <tr>" & chr(13)& _
        ...
        ' CÁLCULOS DE SUB TOTAL
                ...
                sub_total_com = r("vl_total_pagto_liquido_NFS")
                sub_total_com_desc = r("vl_total_pagto")
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Relatório de Pedidos Indicadores Com Desconto (Consulta)</span>
	<br><span class="Rc">

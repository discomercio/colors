...
<%
'     ===============================================
'	  RelProdutoDepositoZonaFiltro.asp
'     ===============================================
'
'
...
<form id="fESTOQ" name="fESTOQ" method="post" action="RelProdutoDepositoZonaExec.asp">
...
<!--  FABRICANTE  -->
	...
	<tr bgColor="#FFFFFF">
		<td class="MDBE">
		<input name="c_fabricante" id="c_fabricante" class="PLLe" maxlength="4" style="margin-left:2pt;width:55px;" onkeypress="if (digitou_enter(true)) bCONFIRMA.focus(); filtra_fabricante();" onblur="this.value=normaliza_codigo(this.value,TAM_MIN_FABRICANTE);"></td>
	</tr>

...
<%
'     ========================================================
'	  R E L A N A L I S E P E D I D O S . A S P
'     ========================================================
'
'
...
var strDtRefYYYYMMDD, strDtRefDDMMYYYY;
	...
	if (f.ckb_periodo_entrega.checked) {
...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelAnalisePedidosExec.asp">
...
<!--  PERÍODO  -->
<tr bgColor="#FFFFFF">
<td colspan="2" class="MT" NOWRAP><span class="PLTe">PERÍODO</span>
	<br>
	...
	<tr bgColor="#FFFFFF"><td>
		<input type="checkbox" tabindex="-1" id="ckb_periodo_cadastro" name="ckb_periodo_cadastro"
			value="PERIODO_CADASTRO_ON"><span class="C" style="cursor:default" 
...
<!--  PRODUTO  -->
<tr bgColor="#FFFFFF">
<td colspan="2" class="MDBE" NOWRAP><span class="PLTe">PRODUTO</span>
	<br>
	<table cellSpacing="0" cellPadding="0" style="margin-bottom:10px;">
	<tr bgColor="#FFFFFF"><td>
		<input type="checkbox" tabindex="-1" id="ckb_produto" name="ckb_produto"
			value="PRODUTO_ON"><span class="C" style="cursor:default" 
			onclick="fFILTRO.ckb_produto.click();">Somente este produto</span
...
<!--  FORNECEDORES  -->
<tr bgColor="#FFFFFF">
<td class="MDBE" NOWRAP><span class="PLTe">FORNECEDOR(ES)</span>
	<br>
	<table cellSpacing="0" cellPadding="0" style="margin-bottom:10px;">
	<tr bgColor="#FFFFFF">
		<td><textarea class="PLBe" style="width:110px;font-size:9pt;margin-left:15px;margin-bottom:0px;" rows="6" name="c_lista_fabricante" id="c_lista_fabricante" onkeypress="if (!digitou_enter(false) && !digitou_char('-')) filtra_numerico();" onblur="this.value=normaliza_lista_fabricantes(this.value);"></textarea></td>
	</table>
</td>
<td class="MDB" NOWRAP><span class="PLTe">LOJA(S)</span>
	<br>
	<table cellSpacing="0" cellPadding="0" style="margin-bottom:10px;">
	<tr bgColor="#FFFFFF">
		<td><textarea class="PLBe" style="width:110px;font-size:9pt;margin-left:15px;margin-bottom:0px;" rows="6" name="c_lista_loja" id="c_lista_loja" onkeypress="if (!digitou_enter(false) && !digitou_char('-')) filtra_numerico();" onblur="this.value=normaliza_lista_lojas(this.value);"></textarea></td></tr>
	</table>
</td></tr>

<!--  CNPJ/CPF  -->
<tr bgColor="#FFFFFF">
<td colspan="2" class="MDBE" NOWRAP><span class="PLTe">CLIENTE</span>
	<br>
	<table cellSpacing="0" cellPadding="0" style="margin-bottom:10px;">
	<tr bgColor="#FFFFFF"><td>
		<span class="C" style="margin-left:30px;">CNPJ/CPF</span><input class="C" maxlength="18" style="width:140px;" name="c_cliente_cnpj_cpf" id="c_cliente_cnpj_cpf" onblur="if (!cnpj_cpf_ok(this.value)) {alert('CNPJ/CPF inválido!!'); this.focus();} else this.value=cnpj_cpf_formata(this.value);" onkeypress="if (digitou_enter(true)&&((!tem_info(this.value))||(tem_info(this.value)&&cnpj_cpf_ok(this.value)))) {this.value=cnpj_cpf_formata(this.value); bCONFIRMA.focus();} filtra_cnpj_cpf();">
		</td></tr>
	</table>
</td></tr>
...
<!--  PF/PJ  -->
<tr bgColor="#FFFFFF">
<td colspan="2" class="MDBE" NOWRAP><span class="PLTe">PF / PJ</span>
	<br>
	<table cellSpacing="0" cellPadding="0" style="margin-left:30px;margin-bottom:10px;">
	<tr bgColor="#FFFFFF"><td>
		<input type="radio" tabindex="-1" id="rb_PF_PJ" name="rb_PF_PJ"
			value="PF_PJ_ON" checked><span class="C" style="cursor:default" 
			onclick="fFILTRO.rb_PF_PJ[0].click();">PF ou PJ</span>
		</td></tr>
	<tr bgColor="#FFFFFF"><td>
		<input type="radio" tabindex="-1" id="rb_PF_PJ" name="rb_PF_PJ"
			value="PF_ON"><span class="C" style="cursor:default" 
			onclick="fFILTRO.rb_PF_PJ[1].click();">PF</span>
		</td></tr>
	<tr bgColor="#FFFFFF"><td>
		<input type="RADIO" tabindex="-1" id="rb_PF_PJ" name="rb_PF_PJ"
			value="PJ_ON"><span class="C" style="cursor:default" 
			onclick="fFILTRO.rb_PF_PJ[2].click();">PJ</span>
		</td></tr>
	</table>
</td></tr>

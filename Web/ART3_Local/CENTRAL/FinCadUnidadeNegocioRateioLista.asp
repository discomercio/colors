...
<tr>
	<td align="RIGHT" vAlign="BOTTOM" NOWRAP><span class="PEDIDO">Relação de Rateios Cadastrados</span>
	<br><span class="Rc">
...
<tr>
	<td align="CENTER"><a href="FinCadUnidadeNegocioRateioMenu.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

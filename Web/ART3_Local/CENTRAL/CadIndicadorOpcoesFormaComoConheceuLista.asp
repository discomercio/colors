...
'	CABEÇALHO
	cab =	"<TABLE class='Q' cellSpacing=0>" & chr(13) & _
			...
			"		<TD width='250' NOWRAP class='MD MB'><P class='R' style='cursor: pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='CadIndicadorOpcoesFormaComoConheceuLista.asp?ord=1" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">&nbsp;OPÇÃO</P></TD>" & chr(13) & _
...
<tr>
	<td align="CENTER"><a href="CadIndicadorOpcoesFormaComoConheceu.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

...
'     ===================================
'	  FinCadUnidadeNegocioRateioMenu.asp
'     ===================================
'
'
...
var s_dest, s_op;
	...
	if (f.rb_op[0].checked) {
		s_dest="FinCadUnidadeNegocioRateioEdita.asp";
		s_op=OP_INCLUI;
		}
		
	if (f.rb_op[1].checked) {
		s_dest="FinCadUnidadeNegocioRateioLista.asp";
		}
...
<span class="T">RATEIO ENTRE AS UNIDADES DE NEGÓCIO</span>
<div class="QFn" align="CENTER">
<table class="TFn">
	<tr>
		<td NOWRAP>
			<input type="RADIO" id="rb_op" name="rb_op" value="1" class="CBOX">
				<span style="cursor:default" onclick="fOP.rb_op[0].click(); fOP.bEXECUTAR.click();">Cadastrar Novo Rateio</span>&nbsp;
			<br>
			<input type="RADIO" id="rb_op" name="rb_op" value="2" class="CBOX">
				<span class="rbLink" onclick="fOP.rb_op[1].click(); fOP.bEXECUTAR.click();">Consultar Lista</span>
			</td>
		</tr>
	</table>

	<span class="R" style="margin: 4 10 0 10">&nbsp;</span>
	<input name="bEXECUTAR" id="bEXECUTAR" type="SUBMIT" class="Botao" value="EXECUTAR" title="executar">

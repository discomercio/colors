...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_CEN_REL_FATURAMENTO_CMVPV, s_lista_operacoes_permitidas) then 
		cn.Close
	...
	dim s_nome_vendedor
    dim c_grupo_pedido_origem, c_pedido_origem
...
dim perc, perc2, perc3, vl_total_saida, vl_total_entrada, vl_sub_total_saida, vl_sub_total_entrada
dim vl_total_valor_RT, vl_total_lucro_liquido, vl_sub_total_valor_RT, vl_sub_total_lucro_liquido
dim vl_lucro_liquido
dim i, v, qtde_total, qtde_sub_total, qtde_fabricantes
...
'	CRIADOS VÁRIOS REGISTROS DE ESTOQUE A DIFERENTES CUSTOS DE AQUISIÇÃO.
  ...
  ' CABEÇALHO
	...
	'	MUDOU DE FABRICANTE?
		  ...
		  ' FECHA TABELA DO FABRICANTE ANTERIOR
			if n_reg_total > 0 then
				...
				if vl_total_saida = 0 then
					...
					perc2 = (vl_sub_total_valor_RT/vl_total_saida)*100
					end if
				...
				x = x & "	<TR NOWRAP style='background: #FFFFDD'>" & chr(13) & _
						...
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_sub_total_entrada) & "</p></td>" & chr(13) & _
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_sub_total_saida-vl_sub_total_entrada) & "</p></td>" & chr(13) & _
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_perc(perc) & "%" & "</p></td>" & chr(13) & _
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_sub_total_valor_RT) & "</p></td>" & chr(13) & _
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_perc(perc2) & "%" & "</p></td>" & chr(13) & _
						"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_sub_total_lucro_liquido) & "</p></td>" & chr(13) & _
			...
			s = s & s_aux
			x = x & cab_table
			if s <> "" then x = x & "	<TR><TD class='MDTE' COLSPAN='11' valign='bottom' class='MB' style='background:azure;'><p class='N'>&nbsp;" & s & "</p></td></tr>" & chr(13)
			x = x & cab
			end if
	 ...
	 '> CÓDIGO DO PRODUTO
		x = x & "		<TD class='MDTE tdCodProd'><P class='Cn' style='color:" & s_cor & ";'>" & Trim("" & r("produto")) & "</P></TD>" & chr(13)

	 '> DESCRIÇÃO DO PRODUTO
		s = Trim("" & r("descricao_html"))
		if s <> "" then s = produto_formata_descricao_em_html(s) else s = "&nbsp;"
		x = x & "		<TD class='MTD tdDescrProd'><P class='Cn' style='color:" & s_cor & ";'>" & s & "</P></TD>" & chr(13)

	 '> QUANTIDADE
		x = x & "		<TD align='right' class='MTD tdQtde'><P class='Cnd' style='color:" & s_cor & ";'>" & formata_inteiro(r("qtde")) & "</P></TD>" & chr(13)

	 '> VALOR SAÍDA
		x = x & "		<TD align='right' class='MTD tdFatTot'><P class='Cnd' style='color:" & s_cor & ";'>" & formata_moeda(r("valor_saida")) & "</P></TD>" & chr(13)

	 '> VALOR ENTRADA
		x = x & "		<TD align='right' class='MTD tdCmvTot'><P class='Cnd' style='color:" & s_cor & ";'>" & formata_moeda(r("valor_entrada")) & "</P></TD>" & chr(13)

	 '> LUCRO BRUTO
		x = x & "		<TD align='right' class='MTD tdLucro'><P class='Cnd' style='color:" & s_cor & ";'>" & formata_moeda(r("valor_saida")-r("valor_entrada")) & "</P></TD>" & chr(13)
	 ...
	 '> PERCENTUAL DO LUCRO BRUTO TOTAL
		...
		x = x & "		<TD align='right' class='MTD tdPercLucroTot'><P class='Cnd' style='color:" & s_cor & ";'>" & formata_perc(perc) & "%" & "</P></TD>" & chr(13)
	 ...
	 '> COMISSÃO (% DO FAT)
		if vl_total_saida = 0 then
			...
			perc2 = (r("valor_RT")/vl_total_saida)*100
			end if
	...
	'>	TOTAL GERAL
		if qtde_fabricantes > 1 then
			...
			x = x & "	<TR><TD COLSPAN='11' style='border-left:0px;border-right:0px;'>&nbsp;</td></tr>" & chr(13) & _
					...
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_total_entrada) & "</p></td>" & chr(13) & _
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_total_saida-vl_total_entrada) & "</p></td>" & chr(13) & _
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_perc(perc) & "%" & "</p></td>" & chr(13) & _
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_total_valor_RT) & "</p></td>" & chr(13) & _
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_perc(perc2) & "%" & "</p></td>" & chr(13) & _
					"		<TD class='MTB'><p class='Cd' style='color:" & s_cor & ";'>" & formata_moeda(vl_total_lucro_liquido) & "</p></td>" & chr(13) & _
					"		<TD class='MTBD'><p class='Cd' style='color:" & s_cor & ";'>" & formata_perc(perc3) & "%" & "</p></td>" & chr(13) & _
					"	</TR>" & chr(13)
			end if
		end if
  ...
  ' MOSTRA AVISO DE QUE NÃO HÁ DADOS!!
	if n_reg_total = 0 then
		...
		x = x & "	<TR NOWRAP>" & chr(13) & _
				"		<TD class='MT' colspan='11'><P class='ALERTA'>&nbsp;NENHUM PRODUTO DO ESTOQUE SATISFAZ AS CONDIÇÕES ESPECIFICADAS&nbsp;</P></TD>" & chr(13) & _
				"	</TR>" & chr(13)
		end if

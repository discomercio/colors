...
dim r
  ...
  ' CABEÇALHO
	...
	cab=cab & "<TD width='35' align='right' NOWRAP class='MD MB'><P class='R' style='cursor: pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='midialista.asp?ord=1" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Nº&nbsp;</P></TD>"
  ...
  ' EXECUTA CONSULTA
	...
	while not r.eof 
	 ...
	 '> Nº
		...
		x=x & ")' title='clique para consultar o cadastro deste veículo de mídia'>"
		x=x & r("id") & "</a></P></TD>"
 	 ...
 	 '> ESTADO
 		if r("indisponivel")=0 then 
 			s="<span style='color:#006600'>Disponível</span>"
 		else 
 			s="<span style='color:#ff0000'>Indisponível</span>"
 			end if
  ...
  ' MOSTRA TOTAL DE VEÍCULOS DE MÍDIA
	x=x & "<TR NOWRAP style='background: #FFFFDD'><TD COLSPAN='3' NOWRAP><P class='Cd'>" & "TOTAL:&nbsp;&nbsp;&nbsp;" & cstr(i) & "&nbsp;&nbsp;veículos de mídia" & "</P></TD></TR>"
...
<tr>
	<td align="right" valign="bottom" nowrap><span class="PEDIDO">Relação de Veículos de Mídia Cadastrados</span>
	<br><span class="Rc">
...
<tr>
	<td align="center"><a href="midia.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

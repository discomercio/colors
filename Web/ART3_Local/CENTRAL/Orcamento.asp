...
var b;
	b=window.confirm('Confirma o cancelamento do orçamento?');
	if (b){
...
<div id="divConsultaOrcamentoWrapper" class="notPrint">
	...
	<span class="Rf">Nº Orçamento</span><br />
...
<!-- ************   BOTÕES   ************ -->
<% if (Not operacao_permitida(OP_CEN_EDITA_ORCAMENTO, s_lista_operacoes_permitidas)) And (Not operacao_permitida(OP_CEN_EDITA_ITEM_DO_ORCAMENTO, s_lista_operacoes_permitidas)) then %>
	...
	<tr>
		...
		<td align="right"><div name="dIMPRIME" id="dIMPRIME">
			<a name="bIMPRIME" id="bIMPRIME" href="javascript:fORCImprime(fORC)" title="exibe o orçamento no formato para impressão em formulário contínuo">
			<img src="../botao/imprimir.gif" width="176" height="55" border="0"></a></div>
		</td>
	</tr>
	</table>
<% elseif r_orcamento.st_orc_virou_pedido = 1 then %>
	<table width="649" cellpadding="0" cellspacing="0">
	<tr>
		<td align="left"><a name="bVOLTAR" id="bVOLTAR" href="javascript:history.back()" title="volta para página anterior">
			<img src="../botao/voltar.gif" width="176" height="55" border="0"></a>
...
<% else %>
	...
	<tr>
		...
		<td align="center">
	<% if (operacao_permitida(OP_CEN_EDITA_ORCAMENTO, s_lista_operacoes_permitidas) Or operacao_permitida(OP_CEN_EDITA_ITEM_DO_ORCAMENTO, s_lista_operacoes_permitidas)) And IsOrcamentoCancelavel(r_orcamento.st_orcamento) then %>
		<div name='dREMOVE' id='dREMOVE'><a name="bREMOVE" id="bREMOVE" href="javascript:fORCRemove(fORC)" title="cancela este orçamento">

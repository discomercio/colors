...
<%
'     =================================================================
'	  P E D I D O A N O T A T R A N S P C O N F I R M A . A S P
'     =================================================================
'
'
...
'	REVISADO P/ IE10
	...
	dim s, usuario, msg_erro, s_log, s_log_transp, s_transportadora, lista_pedidos, v_pedido, i, achou
...
'	=========================
	...
	'	~~~~~~~~~~~~~
			...
			if v_pedido(i) <> "" then
				...
				if rs.Eof then
					...
					if Ucase(Trim("" & rs("transportadora_id"))) <> Ucase(Trim(s_transportadora)) then
						...
						s_log_transp = s_log_transp & v_pedido(i) & ": '" & Trim("" & rs("transportadora_id")) & "' -> '" & Trim(s_transportadora) & "'"
		...
		if alerta = "" then
			s_log = "Anotar transportadora no pedido = " & s_transportadora & "; Pedido(s) = " & s_log & "; Log de alteração da transportadora: " & s_log_transp

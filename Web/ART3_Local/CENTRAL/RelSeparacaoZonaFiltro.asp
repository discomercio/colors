...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelSeparacaoZonaContagem.asp">
...
<tr>
	...
	<table class="Qx" cellspacing="0" cellpadding="0">
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap><span class="PLTe">PERÍODO</span></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="left">
			<table style="margin: 4px 8px 4px 8px;" cellspacing="0" cellpadding="0">
				<tr bgcolor="#FFFFFF">
				<td align="left">
				<input class="Cc" maxlength="10" name="c_dt_inicio" id="c_dt_inicio" style="width:90px;" onblur="if (!isDate(this)) {alert('Data de início inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)&&tem_info(this.value)&&isDate(this)) fFILTRO.c_dt_termino.focus(); filtra_data();">
				&nbsp;<span class="C">&nbsp;até&nbsp;</span>&nbsp;
				<input class="Cc" maxlength="10" name="c_dt_termino" id="c_dt_termino" style="width:90px;" onblur="if (!isDate(this)) {alert('Data de término inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)&&tem_info(this.value)&&isDate(this)) fFILTRO.c_transportadora.focus(); filtra_data();">
				</td>
				</tr>
			</table>
		</td>
...
<!--  NFe EMITIDA  -->
<tr>
	<td class="MB ME MD" align="left" style="padding-bottom:10px;">
	<table class="Qx" cellspacing="0" cellpadding="0">
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap><span class="PLTe">NFe</span></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap>
			<% intIdx=-1 %>
			<input type="radio" id="rb_nfe" name="rb_nfe" value="EMITIDA" checked class="CBOX" style="margin-left:20px;">
			<% intIdx=intIdx+1 %>
			<span style="cursor:default;" class="rbLink" onclick="fFILTRO.rb_nfe[<%=Cstr(intIdx)%>].click();">Somente com NFe <b style="color:green;">já</b> emitida</span>
			<br>
			<input type="radio" id="rb_nfe" name="rb_nfe" value="NAO_EMITIDA" class="CBOX" style="margin-left:20px;">
			<% intIdx=intIdx+1 %>
			<span style="cursor:default;" class="rbLink" onclick="fFILTRO.rb_nfe[<%=Cstr(intIdx)%>].click();">Somente com NFe <b style="color:red;">não</b> emitida</span>
			<br>
			<input type="radio" id="rb_nfe" name="rb_nfe" value="" class="CBOX" style="margin-left:20px;">
			<% intIdx=intIdx+1 %>
			<span style="cursor:default;" class="rbLink" onclick="fFILTRO.rb_nfe[<%=Cstr(intIdx)%>].click();">Ambos</span>
		</td>
	</tr>
	</table>
	</td>
...
<tr>
	...
	<table class="Qx" cellspacing="0" cellpadding="0">
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap><span class="PLTe">TRANSPORTADORA</span></td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="left">
			<table style="margin: 4px 8px 4px 8px;" cellspacing="0" cellpadding="0">
				<tr bgcolor="#FFFFFF">
				<td align="left">
				<select id="c_transportadora" name="c_transportadora" style="margin:4px 4px 4px 3px;" onkeyup="if (window.event.keyCode==KEYCODE_DELETE) this.options[0].selected=true;" onkeypress="if (digitou_enter(true)) fFILTRO.c_qtde_max_pedidos.focus();">
...
<tr>
	...
	<tr bgcolor="#FFFFFF">
		<td align="left" nowrap>
			<span class="PLTe">QTDE MÁXIMA DE PEDIDOS</span>
		</td>
	</tr>
	<tr bgcolor="#FFFFFF">
		<td align="left">
			<table style="margin: 4px 8px 4px 8px;" cellspacing="0" cellpadding="0">
				<tr bgcolor="#FFFFFF">
				<td align="left">
					<input class="Cc" maxlength="4" name="c_qtde_max_pedidos" id="c_qtde_max_pedidos" style="width:60px;" onfocus="this.select();" onblur="this.value=trim(this.value);" onkeypress="if (digitou_enter(true)&&tem_info(this.value)) bCONFIRMA.focus(); filtra_numerico();">
				</td>
				</tr>
			</table>
		</td>

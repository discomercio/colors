...
<%
'     ===================================================================================
'     RelIndicadorSemAvaliacaoDesempenhoExec.asp
'     ===================================================================================
'
'
...
'	VERIFICA PERMISSÃO DE ACESSO DO USUÁRIO
	if Not operacao_permitida(OP_CEN_REL_INDICADOR_SEM_AVALIACAO_DESEMPENHO, s_lista_operacoes_permitidas) then 
		cn.Close
...
dim intLargApelido, intLargNome, intLargCnpjCpf

'	CRITÉRIOS DE RESTRIÇÃO
	s_where = "( (desempenho_nota IS NULL) OR (desempenho_nota = '') )"
...
'	MONTA SQL DE CONSULTA
  ...
  ' CABEÇALHO
	...
	cab = _
		...
		"		<TD class='MTD' valign='bottom'><P style='width:" & CStr(intLargCnpjCpf) & "px' class='R'>CPF / CNPJ</P></TD>" & chr(13) & _
		"	</TR>" & chr(13)
...
'	LAÇO P/ LEITURA DO RECORDSET
	...
	'>  CPF / CNPJ
		x = x & "		<TD class='MTD' valign='top' style='width:" & CStr(intLargCnpjCpf) & "px'>" & _
							"<P class='Cn'>" & _
								"<a href='javascript:fRELConcluir(" & chr(34) & r("apelido") & chr(34) & ")' title='clique para consultar o cadastro'>" & _
								cnpj_cpf_formata(Trim("" & r("cnpj_cpf"))) & _
								"</a>" & _
							"</P>" & _
						"</TD>" & chr(13)
...
<input type="hidden" name="pagina_relatorio_originou_edicao" id="pagina_relatorio_originou_edicao" value='RelIndicadorSemAvaliacaoDesempenhoExec.asp'>

<!--  I D E N T I F I C A Ç Ã O   D A   T E L A  -->
<table width="649" cellPadding="4" CellSpacing="0" style="border-bottom:1px solid black">
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Indicador Sem Avaliação de Desempenho</span>
	<br><span class="Rc">

...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelVendasExec.asp">
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Relatório de Faturamento (Antigo)</span>
	<br><span class="Rc">
...
<!--  PEDIDO  -->
	...
	<br>
		<input maxlength="10" class="PLLe" style="width:100px;" name="c_pedido" id="c_pedido" onblur="if (normaliza_num_pedido(this.value)!='') this.value=normaliza_num_pedido(this.value);" onkeypress="if (digitou_enter(true)) fFILTRO.c_loja.focus(); filtra_pedido();">
		</td></tr>
...
<!--  LOJA  -->
	...
	<br>
		<textarea class="PLBe" style="width:100px;font-size:9pt;margin-bottom:4px;margin-left:10px;" rows="8" name="c_loja" id="c_loja" onkeypress="if (!digitou_enter(false) && !digitou_char('-')) filtra_numerico();" onblur="this.value=normaliza_lista_lojas(this.value);"></textarea>
	</td></tr>

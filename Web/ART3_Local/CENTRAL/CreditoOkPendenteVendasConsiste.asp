...
<%
'     ==============================================================================
'	  CreditoOkPendenteVendasConsiste.asp
'     ==============================================================================
'
'
...
function fPendVendasCrOkConfirma( f ) {
...
<form id="fPendVendasCrOk" name="fPendVendasCrOk" method="post" action="CreditoOkPendenteVendasConfirma.asp">
...
<tr>
	<td align="right" valign="bottom"><span class="PEDIDO">Crédito OK (Pendente Vendas)</span></td>
</tr>
</table>
<br>
...
<tr>
	...
	<a name="bCONFIRMA" id="bCONFIRMA" href="javascript:fPendVendasCrOkConfirma(fPendVendasCrOk)" title="confirma a alteração para '<%=x_analise_credito(COD_AN_CREDITO_OK)%>'">

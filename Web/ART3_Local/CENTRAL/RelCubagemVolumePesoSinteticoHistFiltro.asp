...
<%
'     =============================================================================
'	  RelCubagemVolumePesoSinteticoHistFiltro.asp
'     =============================================================================
'
'
...
function fFILTROConfirma(f) {
	...
	if ((trim(f.c_dt_entregue_inicio.value) == "") && (trim(f.c_dt_entregue_termino.value) == "")) {
		alert("Nenhuma data foi informada!!");
		return;
	}
...
<form id="fFILTRO" name="fFILTRO" method="post" action="RelCubagemVolumePesoSinteticoHistExec.asp">
...
<!--  DATA DO PEDIDO ENTREGUE  -->
	<tr bgcolor="#FFFFFF">
	<td class="MT" align="left" nowrap><span class="PLTe">ENTREGUE EM</span>
	<br>
		<input class="PLLc" maxlength="10" style="width:80px;" name="c_dt_entregue_inicio" id="c_dt_entregue_inicio" onblur="if (!isDate(this)) {alert('Data inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)) fFILTRO.c_dt_entregue_termino.focus(); filtra_data();">
		<span class="C">&nbsp;até&nbsp;</span>
		<input class="PLLc" maxlength="10" style="width:80px;" name="c_dt_entregue_termino" id="c_dt_entregue_termino" onblur="if (!isDate(this)) {alert('Data inválida!'); this.focus();}" onkeypress="if (digitou_enter(true)) fFILTRO.c_transportadora.focus(); filtra_data();">
	</td></tr>

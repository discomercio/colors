...
<%
'     =====================================
'	  FinCadPlanoContasGrupoLista.asp
'     =====================================
'
'
...
dim strTextoStatusInativo, strTextoStatusAtivo
  ...
  ' CABEÇALHO
	cab = _
			...
			"		<TD width='35' align='center' NOWRAP class='MD MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasGrupoLista.asp?ord=1" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Id</P></TD>" & chr(13) & _
			"		<TD width='" & w_descricao & "' NOWRAP class='MD MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasGrupoLista.asp?ord=2" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">&nbsp;Descrição</P></TD>" & chr(13) & _
			"		<TD width='70' align='center' NOWRAP class='MB'><P class='R' style='cursor:pointer;' title='clique para ordenar a lista por este campo' onclick=" & chr(34) & "window.location='FinCadPlanoContasGrupoLista.asp?ord=3" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & "';" & chr(34) & ">Status</P></TD>" & chr(13) & _
			"	</TR>" & chr(13)

	consulta = "SELECT * FROM t_FIN_PLANO_CONTAS_GRUPO ORDER BY "
	...
	while not r.eof 
	 ...
	 '> ID
		x = x & _
			...
			normaliza_codigo(r("id"),TAM_PLANO_CONTAS__GRUPO) & "</a></P></TD>" & chr(13)
...
<tr>
	<td align="RIGHT" vAlign="BOTTOM" NOWRAP><span class="PEDIDO">Plano de Contas: Relação de Grupos Cadastrados</span>
	<br><span class="Rc">
...
<br>
<center>
<form method="post" action="FinCadPlanoContasGrupoEdita.asp" id="fOP" name="fOP">
...
<tr>
	<td align="CENTER"><a href="FinCadPlanoContasGrupoMenu.asp<%= "?" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo"))%>" title="volta para a página anterior">

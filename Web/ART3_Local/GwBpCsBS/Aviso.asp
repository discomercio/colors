...
'	MENSAGENS DE ERROS
	...
	if Cstr(id) = Cstr(ERR_SESSAO) then mensagem = "Falha ao iniciar sessão.<br>Por favor, verifique se a gravação de cookies está habilitada em seu navegador."

	url_retorno = "SessaoEncerra.asp"

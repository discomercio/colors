...
'	REDIRECIONA P/ A PÁGINA P030PagtoVerificaStatus.asp PARA QUE O CLIENTE VEJA AS TRANSAÇÕES BEM SUCEDIDAS
	...
	'	FECHA CONEXÃO
		...
		Response.Redirect("P030PagtoVerificaStatus.asp?pedido_selecionado=" & pedido_selecionado & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")))
		end if
...
'	GRAVA AS INFORMAÇÕES NO BANCO DE DADOS
	...
	'	PERMITE RECRIAR A SESSÃO CASO ELA TENHA EXPIRADO QUANDO A PÁGINA DE RETORNO FOR ATIVADA
		t_PAG("SessionCtrlInfo") = Session("SessionCtrlInfo")
...
'	FECHA CONEXÃO
	...
	'	REDIRECIONAMENTO P/ PÁGINA DE EXIBIÇÃO DE MENSAGEM COM O STATUS DA TRANSAÇÃO
		Response.Redirect("P090MsgResultadoPrepara.asp?idPagtoGwPag=" & criptografa(Cstr(idPagtoGwPag)) & "&pedido=" & pedido_selecionado & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")))
	else
	'	REDIRECIONAMENTO P/ PÁGINA DE EXIBIÇÃO DE MENSAGEM DE ERRO (EXIBIR A MENSAGEM NESTA MESMA PÁGINA AUMENTA O RISCO DO USUÁRIO ATUALIZAR A PÁGINA E EXECUTAR NOVAMENTE A TRANSAÇÃO)
	'	A MENSAGEM DE ERRO ESTÁ GRAVADA EM t_PAGTO_GW_PAG.msg_alerta_tela
		Response.Redirect("P090MsgErroPrepara.asp?idPagtoGwPag=" & criptografa(Cstr(idPagtoGwPag)) & "&pedido=" & pedido_selecionado & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")))
		end if
...
dim x
	x = DOCTYPE_LEGADO & chr(13) & _
		...
		"			<td align=" & chr(34) & "center" & chr(34) & ">" & chr(13) & _
						"<a name=" & chr(34) & "bVOLTAR" & chr(34) & " href=" & chr(34) & "../Loja/pedido.asp?pedido_selecionado=" & pedido_selecionado & "&url_back=X" & "&" & MontaCampoQueryStringSessionCtrlInfo(Session("SessionCtrlInfo")) & chr(34) & ">" & chr(13) & _

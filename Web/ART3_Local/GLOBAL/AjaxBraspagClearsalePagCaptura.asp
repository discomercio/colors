...
<%
'     =============================================================
'	  AjaxBraspagClearsalePagCaptura.asp
'     =============================================================
'
'
...
'	CAPTURA
	...
	call BraspagClearsaleProcessaRequisicao_CaptureCreditCardTransaction(id_pagto_gw_pag, id_pagto_gw_pag_payment, usuario, trx_Capture, r_rx_Capture, msg_erro)
	if msg_erro <> "" then
		Response.Write msg_erro
		Response.End
		end if
